...
function expose(){var t=window.GeoDash;GeoDash.noConflict=function(){return window.GeoDash=t,this},window.GeoDash=GeoDash}var _ezoop=window.ezoop,ezoop=function(){};ezoop.version="0.1",ezoop.noConflict=function(){return window.ezoop=_ezoop,this},window.ezoop=ezoop,ezoop.ExtendedClass=function(t,e){return ezoop.Class(t,e)},ezoop.BaseClass=function(t){return ezoop.Class(null,t)},ezoop.Class=function(t,e){var i=null,n=ezoop.Class;return null==t||"undefined"==typeof t?(i=function(){"undefined"!=typeof this.initialize&&this.initialize.apply(this,arguments)},i.prototype=e):(i=function(){if("undefined"!=typeof t.prototype){var e=t.prototype.initialize;"function"==typeof e&&e.apply(this,arguments)}var i="function"==typeof this.initialize?this.initialize:"undefined";"function"==typeof i&&i.apply(this,arguments)},n.inheritPrototype(i,t),n.augmentPrototype(i.prototype,e)),i},ezoop.Class.inheritPrototype=function(t,e){var i=function(){};i.prototype=e.prototype,t.prototype=new i,t.prototype.constructor=t,t.parent=e.prototype},ezoop.Class.augmentPrototype=function(t,e){if(t=t||{},e){for(var i in e){var n=e[i];void 0!==n&&(t[i]=n)}var o="function"==typeof window.Event&&e instanceof window.Event;!o&&e.hasOwnProperty&&e.hasOwnProperty("toString")&&(t.toString=e.toString)}};var GeoDash={version:"0.2-dev"};expose(),function(){var t=navigator.userAgent.toLowerCase(),e=document.documentElement,i="ActiveXObject"in window,n=-1!==t.indexOf("webkit"),o=-1!==t.indexOf("phantom"),a=-1!==t.search("android [23]"),s="undefined"!=typeof orientation,r=navigator.msPointerEnabled&&navigator.msMaxTouchPoints&&!window.PointerEvent,l=window.PointerEvent&&navigator.pointerEnabled&&navigator.maxTouchPoints||r,h=i&&"transition"in e.style,d="WebKitCSSMatrix"in window&&"m11"in new window.WebKitCSSMatrix&&!a,u="MozPerspective"in e.style,p="OTransition"in e.style,c="devicePixelRatio"in window&&window.devicePixelRatio>1;if(!c&&"matchMedia"in window){var f=window.matchMedia("(min-resolution:144dpi)");c=f&&f.matches}var g=!window.L_NO_TOUCH&&!o&&(l||"ontouchstart"in window||window.DocumentTouch&&document instanceof window.DocumentTouch);GeoDash.Browser={ie:i,ielt9:i&&!document.addEventListener,webkit:n,gecko:-1!==t.indexOf("gecko")&&!n&&!window.opera&&!i,android:-1!==t.indexOf("android"),android23:a,chrome:-1!==t.indexOf("chrome"),ie3d:h,webkit3d:d,gecko3d:u,opera3d:p,any3d:!window.L_DISABLE_3D&&(h||d||u||p)&&!o,mobile:s,mobileWebkit:s&&n,mobileWebkit3d:s&&d,mobileOpera:s&&window.opera,touch:!!g,msPointer:!!r,pointer:!!l,retina:!!c}}(),GeoDash.Chart=ezoop.BaseClass({className:"Chart",defaults:{},initialize:function(t,e){this.el=t,this.options={},this.activeBar=-1,this.setOptions(e),this.makeTitle(),this.setUpChart(),this.drawChart()},setOptions:function(t){for(var e in this.defaults)this.defaults.hasOwnProperty(e)&&void 0===t[e]&&(t[e]=this.defaults[e]);this.options=t},setUpChart:function(){d3.select(this.el).style("position","relative")},drawChart:function(){var t=this;this.setWidth(),this.setHeight(),this.setXAxis(),this.setYAxis(),this.formatPercent=d3.format(".0%"),this.formatLarge=d3.format("s"),this.formatComma=d3.format(","),this.formatPercentAxisLabel=d3.format("p"),this.formatMoney=d3.format("$"),this.container=d3.select(this.el).append("div").attr("class",function(){return"geodash "+t.options.class}).style("width",this.width+"px").style("height",this.height+"px").style("margin-top",this.options.margin.top+"px").style("margin-bottom",this.options.margin.bottom+"px").style("margin-left",this.options.margin.left+"px").style("margin-right",this.options.margin.right+"px"),this.xAxisElement=this.container.append("div").attr("class","x axis").style("margin-left",function(){return t.marginleft+"px"}).style("width",function(){return t.xrange+"px"}),t.options.xLabel&&this.xAxisElement.append("div").attr("class","xAxisLabel").style("height",this.options.axisLabelPadding+"px").append("div").attr("class","gd-label").style("line-height",this.options.axisLabelPadding+"px").text(this.options.xLabel),this.yAxisElement=this.container.append("div").attr("class","y axis").style("width",function(){return t.xrange+t.marginleft+"px"}),t.options.yLabel&&this.yAxisElement.append("div").attr("class","yAxisLabel").style("height",this.options.axisLabelPadding+"px").style("width",this.height+"px").append("div").attr("class","gd-label").style("line-height",this.options.axisLabelPadding+"px").text(this.options.yLabel),this.container.append("div").attr("class","bars").style("height",function(){return t.yrange+"px"}).style("width",function(){return t.xrange+"px"}).style("margin-left",function(){return t.marginleft+"px"}),this.options.legend&&this.container.append("div").attr("class","legend").style("width",this.options.legendWidth+"px").style("background",function(){var e=d3.select(t.el).style("background-color");return e}),"LineChart"===this.className&&(this.svg=this.container.select(".bars").append("svg")),"PieChart"===this.className&&(this.svg=this.container.select(".bars").append("svg").append("g").attr("transform","translate("+t.xrange/2+","+this.height/2+")")),this.container.append("div").attr("class","hoverbox")},updateChart:function(){},setXAxis:function(){var t=this.width,e=0;this.options.legend&&(t-=this.options.legendWidth),this.options.drawY&&(t-=this.options.yaxisLabelPadding,e+=this.options.yaxisLabelPadding),this.options.yLabel&&(t-=this.options.axisLabelPadding,e+=this.options.axisLabelPadding),this.xrange=t,this.marginleft=e,this.x=d3.scale.ordinal().rangeRoundBands([0,t],.05,this.options.outerPadding)},setYAxis:function(){var t=this.height;this.options.xLabel&&(t-=this.options.axisLabelPadding),this.options.drawX&&(t-=this.options.axisLabelPadding),this.yrange=t,this.y=d3.scale.linear().range([t,0])},updateYAxis:function(){var t=this;if(this.options.drawY){var e=this.y.ticks(),i=this.yAxisElement.selectAll(".tick").data(e),e=i.transition().style("top",function(e){return t.y(e)+"px"});e.select(".gd-label").text(function(e){var i=t.formatLarge(e);return t.options.money&&(i="$"+i),t.options.percent&&(i+="%"),i});var n=i.enter().append("div").attr("class","tick").style("top",function(e){return t.y(e)+"px"}).style("left",function(){return t.options.yLabel?t.options.axisLabelPadding+"px":void 0}).style("width",function(){return t.options.yLabel?t.width-t.options.axisLabelPadding+"px":t.width+"px"});i.exit().remove(),n.append("div").attr("class","line").style("width","100%"),n.append("div").attr("class","gd-label").text(function(e){var i=t.formatLarge(e);return t.options.money&&(i="$"+i),t.options.percent&&(i+="%"),i}).style("margin-top",function(){var t=d3.select(this).style("height"),e=parseInt(t)/2*-1;return e+"px"}).style("width",t.options.yaxisLabelPadding+"px").style("background",function(){var e=d3.select(t.el).style("background-color");return e})}},updateXAxis:function(){var t=this;if(this.options.drawX){var e=this.x.domain(),i=this.xAxisElement.selectAll(".tick").data(e),n=i.transition().style("left",function(e){return t.x(e)+"px"}).style("width",t.x.rangeBand()+"px");n.select(".line").style("margin-left",function(){var e=t.x.rangeBand()/2;return e+"px"}),n.select(".gd-label").text(function(e){return t.options.xFormat?t.options.xFormat(e):e});var o=i.enter().append("div").attr("class","tick").style("left",function(e){return t.x(e)+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(){var e=t.height-t.yrange-t.options.axisLabelPadding;return e+"px"}).style("height",t.options.axisLabelPadding+"px");i.exit().remove(),o.append("div").attr("class","line").style("margin-left",function(){var e=t.x.rangeBand()/2;return e+"px"}),o.append("div").attr("class","gd-label").text(function(e){return t.options.xFormat?t.options.xFormat(e):e})}},updateLegend:function(){if(this.options.legend){var t={width:10,height:10,padding:5},e=3,i=this.container.select(".legend"),n=this.color.domain().slice().reverse(),o=i.selectAll(".legend-item").data(n),a=(o.select(".value").text(function(t){return t}),o.enter().append("div").attr("class","legend-item"));a.append("div").attr("class","swatch").style("float","left").style("width",t.width+"px").style("height",t.height+"px").style("margin-left",e+"px").style("background",this.color),a.append("div").attr("class","value").style("width",this.options.legendWidth-t.width-2*e+"px").style("padding-left",e+"px").text(function(t){return t}),o.exit().remove();var s=parseInt(i.style("height")),r=this.height/2-s/2;i.style("top",r+"px")}},update:function(){},makeTitle:function(){if(this.options.title){var t='<div class="geodash-title">'+this.options.title+"</div>";d3.select(this.el).html(t)}},getData:function(){return this.data},setWidth:function(){this.width=parseInt(d3.select(this.el).style("width")),this.width=this.width-this.options.margin.left-this.options.margin.right},setHeight:function(){0!==this.options.barHeight&&"undefined"!=typeof this.options.barHeight&&d3.select(this.el).style("height","auto"),this.height=parseInt(d3.select(this.el).style("height")),this.height=this.height-this.options.margin.top-this.options.margin.bottom,this.options.title&&(this.height=this.height-30)},setYAxisLabel:function(t){this.container.select(".y.axis .yAxisLabel .gd-label").text(t)},setXAxisLabel:function(t){this.container.select(".y.axis .xAxisLabel .gd-label").text(t)}}),GeoDash.BarChartHorizontal=ezoop.ExtendedClass(GeoDash.Chart,{className:"BarChartHorizontal",defaults:{x:"x",y:"y",barColors:["#f00"],opacity:.7,drawX:!1,drawY:!1,percent:!1,money:!1,title:!1,roundRadius:3,highlight:[],invert:!1,barHeight:0,padding:2,numberTicks:10,yWidth:0,round:!0,format:!1,topPadding:10,axisLabelPadding:20,legendWidth:80,legend:!1,rightBarPadding:10,outerPadding:.5,"class":"chart-html horizontal",hoverTemplate:"{{y}}: {{x}}",formatter:d3.format(","),xFormat:!1,margin:{top:10,right:10,bottom:10,left:10}},initialize:function(){},setXAxis:function(){var t=this.width,e=0;this.options.legend&&(t-=this.options.legendWidth),this.options.drawY&&(t-=this.options.yWidth,e+=this.options.yWidth),this.options.yLabel&&(t-=this.options.axisLabelPadding,e+=this.options.axisLabelPadding),this.xrange=t,this.marginleft=e,this.x=d3.scale.linear().range([0,t-this.options.rightBarPadding]).nice()},setYAxis:function(){var t=this.height;this.options.drawX&&(t-=this.options.axisLabelPadding),this.options.xLabel&&(t-=this.options.axisLabelPadding),this.yrange=t,this.y=d3.scale.ordinal().rangeRoundBands([t,0],.05,this.options.outerPadding)},update:function(t){function e(t,e,i){null!=t[e]&&"string"==typeof t[e]&&(t[e]=+t[e].replace(",",""));var n={x:t[e],y:t[i]};return n}if(this.data=t,0!==this.options.barHeight){var i=this.options.barHeight*t.length+this.options.padding*t.length+2*this.options.topPadding;this.options.drawX&&(i+=this.options.axisLabelPadding),this.options.xLabel&&(i+=this.options.axisLabelPadding),this.container.select(".bars").style("height",i+"px"),this.setHeight(),this.setYAxis()}var n=[],o=this.options.y,a=this.options.x,s=[];t.reverse();for(var r=0;r<t.length;r++){var l=t[r],h=0;if("object"==typeof a)this.stackNumber=a.length,s=a,a.forEach(function(t){var i=e(l,t,o);n.push(i),h+=i.x});else{this.stackNumber=1,s=[a];var d=e(l,a,o);n.push(d),h+=d.x}n[r].total=h}this._data=n,this.color=d3.scale.ordinal().range(this.options.barColors).domain(s);var u=d3.extent(this._data,function(t){return t.total});u[0]<0?this.x.domain(u):this.x.domain([0,u[1]]),this.y.domain(this._data.map(function(t){return t.y})),this.updateChart(),this.updateXAxis(),this.updateYAxis(),this.updateLegend()},updateChart:function(){var t=this,e=(this.options.y,this.options.x,this.container.select(".bars").selectAll(".bar").data(this._data));e.transition().attr("geodash-id",function(t){return t.y}).style("left",function(e,i){for(var n=t.x(Math.min(0,e.x)),o=i%t.stackNumber;o>0;){var a=t._data[i-o].x;n+=t.x(a),o--}return n+=1,n+"px"}).style("top",function(e,i){var n=0;return n=0!==t.options.barHeight?t.options.barHeight*i+t.options.padding*i+t.options.topPadding:t.y(e.y),n+"px"}).style("width",function(e){var i=Math.abs(t.x(e.x)-t.x(0));return i+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("opacity",function(e){for(var i=0;i<t.options.highlight.length;i++)if(t.options.highlight[i]==e.y)return 1;return t.options.opacity}).style("border-top-right-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-right-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-top-left-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-left-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("background-color",function(e,i){return t.options.barColors[i%t.stackNumber]},"important");var i=e.enter().append("div").attr("class","bar").attr("geodash-id",function(t){return t.y}).style("left",function(e,i){for(var n=t.x(Math.min(0,e.x)),o=i%t.stackNumber;o>0;){var a=t._data[i-o].x;n+=parseInt(t.x(a)),o--}return n+=1,n=parseInt(n),n+"px"}).style("top",function(e,i){var n=0;return n=0!==t.options.barHeight?t.options.barHeight*i+t.options.padding*i+t.options.topPadding:t.y(e.y),n+"px"}).style("width",function(e){var i=Math.abs(t.x(e.x)-t.x(0));return i=parseInt(i),i+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("opacity",function(e){for(var i=0;i<t.options.highlight.length;i++)if(t.options.highlight[i]==e.y)return 1;return t.options.opacity}).style("border-top-right-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-right-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-top-left-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-left-radius",function(e,i){var n=(i+1)%t.stackNumber;if(n)return 0;var o=0,a=t.x(Math.min(0,e.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("-webkit-print-color-adjust","exact").style("background-color",function(e,i){return t.options.barColors[i%t.stackNumber]},"important");e.exit().remove(),i.on("mouseover",function(e,i){GeoDash.Browser.touch||t.mouseOver(e,i,this)}).on("mouseout",function(e,i){GeoDash.Browser.touch||t.mouseOut(e,i,this)}).on("click",function(e,i){t.activeBar===i?(t.activeBar=-1,t.mouseOut(e,i,this)):(t.activeBar=i,t.mouseOver(e,i,this))})},updateXAxis:function(){var t=this;if(this.options.drawX){var e=(this.container.select(".bars").style("height"),this.x.ticks(t.options.numberTicks)),i=this.xAxisElement.selectAll(".tick").data(e),e=i.transition().style("left",function(e){var i=t.x(e);return i+"px"}).style("height",function(){return t.options.xLabel?t.height-t.options.axisLabelPadding+"px":t.height+"px"});e.select(".gd-label").text(function(e){if(t.options.xFormat)return t.options.xFormat(e);var i=t.formatLarge(e);return t.options.money&&(i="$"+i),t.options.percent&&(i+="%"),i});var n=i.enter().append("div").attr("class","tick").style("left",function(e){var i=t.x(e);return i+"px"}).style("bottom",function(){return t.options.yLabel?t.options.axisLabelPadding+"px":void 0}).style("height",function(){return t.options.xLabel?t.height-t.options.axisLabelPadding+"px":t.height+"px"});i.exit().remove(),n.append("div").attr("class","line").style("height","100%"),n.append("div").attr("class","gd-label").text(function(e){if(t.options.xFormat)return t.options.xFormat(e);var i=t.formatLarge(e);return t.options.money&&(i="$"+i),t.options.percent&&(i+="%"),i}).style("bottom","0px").style("background",function(){var e=d3.select(t.el).style("background-color");return e}).style("margin-left",function(){var t=d3.select(this).style("width"),e=parseInt(t)/2*-1;return e+"px"}).style("height",t.options.axisLabelPadding+"px").style("line-height",t.options.axisLabelPadding+"px")}},updateYAxis:function(){var t=this,e="x";if(this.options.drawY){var i=parseInt(d3.select(t.el).select(".bars").style("width"));isNaN(i)||(barWidth=i);{var n=this.y.domain(),o=this.yAxisElement.selectAll(".tick").data(n);o.transition().style("top",function(e,i){var n=0;return n=0!==t.options.barHeight?t.options.barHeight*i+t.options.padding*i+t.options.topPadding:t.y(e),n+"px"}).style("right",function(){return"0px"}).style("padding-right",function(i,n){var o=t._data[n][e],a=t.x(Math.min(0,o)),s=barWidth-a+2;return s+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("line-height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).select(".gd-label").style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).text(function(t){return t}),o.enter().append("div").attr("class","tick").style("top",function(e,i){var n=0;return n=0!==t.options.barHeight?t.options.barHeight*i+t.options.padding*i+t.options.topPadding:t.y(e),n+"px"}).style("right",function(){return"0px"}).style("padding-right",function(i,n){var o=t._data[n][e],a=t.x(Math.min(0,o)),s=barWidth-a+2;return s+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("line-height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).append("div").attr("class","gd-label").style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).text(function(t){return t})}o.exit().remove()}},mouseOver:function(t,e,i){var n,o,a=this,s="",o=a._data[e].x,n=a._data[e].y;if("object"==typeof a.options.x&&(n+=" "+a.options.x[e%a.stackNumber]),null!==o){o=a.options.formatter(o);var r={y:n,x:o};s=Mustache.render(a.options.hoverTemplate,r)}else s="NA";a.container.selectAll(".bar").style("opacity",function(t,e){return e!==a.activeBar?a.options.opacity:1}),d3.select(i).style("opacity",1),a.container.select(".hoverbox").html(s),a.container.select(".hoverbox").transition().style("display","block")},mouseOut:function(t,e,i){for(var n=this,o=n.options.opacity,a=0;a<n.options.highlight.length;a++)n.options.highlight[a]==t&&(o=1);if(d3.select(i).style("opacity",o),n.container.select(".hoverbox").transition().style("display","none"),n.activeBar>=0){var s=n.container.selectAll(".bar")[0][n.activeBar];n.mouseOver(t,n.activeBar,s)}},setColor:function(t){this.options.barColors=t}}),GeoDash.BarChartVertical=ezoop.ExtendedClass(GeoDash.Chart,{className:"BarChartVertical",defaults:{x:"x",y:"y",barColors:["#f00"],opacity:.7,drawX:!1,drawY:!1,xLabel:!1,yLabel:!1,percent:!1,title:!1,roundRadius:3,highlight:!1,verticalX:!1,invert:!1,roundRadius:3,legendWidth:80,legend:!1,axisLabelPadding:20,yaxisLabelPadding:25,"class":"chart-html vertical",outerPadding:.5,hoverTemplate:"{{x}}: {{y}}",formatter:d3.format(","),margin:{top:10,right:10,bottom:10,left:10}},initialize:function(){},update:function(t){function e(t,e,i){null!=t[i]&&"string"==typeof t[i]&&(t[i]=+t[i].replace(",",""));var n={x:t[e],y:t[i]};return n}var i=this.options.y,n=this.options.x;this.data=t;for(var o=[],i=this.options.y,n=this.options.x,a=[],s=0;s<t.length;s++){var r=t[s],l=0;if("object"==typeof i)this.stackNumber=i.length,a=i,i.forEach(function(t){var i=e(r,n,t);o.push(i),l+=i.y});else{this.stackNumber=1,a=[i];var h=e(r,n,i);o.push(h),l+=h.y}o[s].total=l}this._data=o,this.color=d3.scale.ordinal().range(this.options.barColors).domain(a),this.x.domain(this._data.map(function(t){return t.x}));var d=d3.extent(this._data,function(t){return t.total});d[0]<0?this.y.domain(d):this.y.domain([0,d[1]]),this.updateChart(),this.updateXAxis(),this.updateYAxis(),this.updateLegend()},updateChart:function(){var t=this,e="y",i="x",n=this.container.select(".bars").selectAll(".bar").data(this._data);n.transition().attr("geodash-id",function(t){return t[i]}).style("left",function(e){return t.x(e[i])+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(e,i){var n=0;n=e.y>0?t.yrange-t.y(0):t.yrange-t.y(e.y);for(var o=i%t.stackNumber;o>0;){var a=t._data[i-o].y;n+=parseInt(t.yrange-t.y(a)),o--}return n=parseInt(n),n+"px"}).style("height",function(i){var n=0;return n=i[e]>0?t.y(0)-t.y(i[e]):t.y(i[e])-t.y(0),n+"px"}).style("opacity",function(e){return e[i]==t.options.highlight?1:t.options.opacity}).style("background-color",function(e,i){return t.options.barColors[i%t.stackNumber]}).style("border-top-right-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]>0?t.options.roundRadius+"px":0}).style("border-top-left-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]>0?t.options.roundRadius+"px":0}).style("border-bottom-right-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]<0?t.options.roundRadius+"px":0}).style("border-bottom-left-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]<0?t.options.roundRadius+"px":0}).style("background-color",function(e,i){return t.options.barColors[i%t.stackNumber]},"important"),n.enter().append("div").attr("class","bar").attr("geodash-id",function(t){return t[i]}).style("left",function(e){return t.x(e[i])+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(e,i){var n=0;n=e.y>0?t.yrange-t.y(0):t.yrange-t.y(e.y);for(var o=i%t.stackNumber;o>0;){var a=t._data[i-o].y;n+=parseInt(t.yrange-t.y(a)),o--}return n=parseInt(n),n+"px"}).style("height",function(i){var n=0;return n=i[e]>0?t.y(0)-t.y(i[e]):t.y(i[e])-t.y(0),n+"px"}).style("opacity",function(e){return e[i]==t.options.highlight?1:t.options.opacity}).style("background-color",function(e,i){return t.options.barColors[i%t.stackNumber]},"important").style("border-top-right-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]>0?t.options.roundRadius+"px":0}).style("border-top-left-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]>0?t.options.roundRadius+"px":0}).style("border-bottom-right-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]<0?t.options.roundRadius+"px":0}).style("border-bottom-left-radius",function(i,n){var o=(n+1)%t.stackNumber;return o?0:i[e]<0?t.options.roundRadius+"px":0}).on("mouseover",function(e,i){GeoDash.Browser.touch||t.mouseOver(e,i,this)}).on("mouseout",function(e,i){GeoDash.Browser.touch||t.mouseOut(e,i,this)}).on("click",function(e,i){t.activeBar===i?(t.activeBar=-1,t.mouseOut(e,i,this)):(t.activeBar=i,t.mouseOver(e,i,this))}),n.exit().remove()},mouseOver:function(t,e,i){var n,o,a=this,s="",o=a._data[e].x,n=a._data[e].y;if("object"==typeof a.options.y&&(o+=" "+a.options.y[e%a.stackNumber]),null!==n){n=a.options.formatter(n);var r={y:n,x:o};s=Mustache.render(a.options.hoverTemplate,r)}else s="NA";a.container.selectAll(".bar").style("opacity",function(t,e){return e!==a.activeBar?a.options.opacity:1}),d3.select(i).style("opacity",1),a.container.select(".hoverbox").html(s),a.container.select(".hoverbox").transition().style("display","block")},mouseOut:function(t,e,i){var n=this,o=n.options.opacity;if(t[n.options.x]==n.options.highlight&&(o=1),d3.select(i).style("opacity",o),n.container.select(".hoverbox").transition().style("display","none"),n.activeBar>=0){var a=n.container.selectAll(".bar")[0][n.activeBar];n.mouseOver(t,n.activeBar,a)}},setColor:function(t){this.options.barColors=t}}),GeoDash.LineChart=ezoop.ExtendedClass(GeoDash.Chart,{className:"LineChart",defaults:{x:"x",y:"y",width:"auto",height:"auto",colors:["#d80000","#006200"],interpolate:"monotone",dotRadius:3,title:!1,opacity:.5,strokeWidth:2,drawX:!0,drawY:!0,xLabel:!1,yLabel:!1,xInterval:"auto",dashed:!1,time:!0,legendWidth:80,legend:!1,axisLabelPadding:20,yaxisLabelPadding:25,"class":"chart-html linechart vertical",xFormat:d3.time.format("%Y-%m-%d"),hoverTemplate:"{{x}}: {{y}}",formatter:d3.format(","),outerPadding:0,margin:{top:10,right:10,bottom:10,left:10}},initialize:function(){},update:function(t){var e=this;if(this.data=t,this.color=d3.scale.ordinal().range(this.options.colors),this.color.domain(d3.keys(t[0]).filter(function(t){return t!==e.options.x})),this.linedata=this.color.domain().map(function(i){return{name:i,values:t.map(function(t){var n,o=t[e.options.x];return n=null===t[i]?null:+t[i],{date:o,value:n}})}}),this.options.dashed){var i=[];this.options.dashed.forEach(function(t){var n=e.linedata[t.line];if("undefined"!=typeof n){var o={};o.name=JSON.parse(JSON.stringify(n.name)),o.values=[],o.dashed=!0,t.span.forEach(function(t){for(var e=t.start;e<=t.end;e++)o.values.push({date:n.values[e].date,value:JSON.parse(JSON.stringify(n.values[e].value))}),e!==t.end&&(n.values[e].value=null)}),i.push(o)}}),i.forEach(function(t){e.linedata.push(t)})}for(var n=0;n<this.linedata.length;n++){for(var o=[],a=0;a<this.linedata[n].values.length;a++){var s=this.linedata[n].values[a].value;isNaN(s)||null===s||o.push(this.linedata[n].values[a])}this.linedata[n].values=o}this.xLine=this.options.time?d3.time.scale().range([0,this.xrange]):d3.scale.linear().range([0,this.xrange]),this.xLine.domain(d3.extent(this.data,function(t){return t[e.options.x]})),"auto"==e.options.xInterval?this.xLine.ticks(t.length):this.xLine.ticks(e.options.xInterval),this.x.domain(this.xLine.ticks()),this.y.domain([d3.min(this.linedata,function(t){return d3.min(t.values,function(t){return t.value})}),d3.max(this.linedata,function(t){return d3.max(t.values,function(t){return t.value})})]);var r=this.y.domain();this.y.domain([r[0]-.1*r[0],r[1]+.1*r[1]]),this.updateChart(),this.updateXAxis(),this.updateYAxis(),this.updateLegend()},updateChart:function(){var t=this;this.line=d3.svg.line().interpolate(this.options.interpolate).x(function(e){return t.x(e.date)+t.x.rangeBand()/2}).y(function(e){return t.y(e.value)});var e=function(t,e){return 10*e},i=this.svg.selectAll(".line_group").data(this.linedata),n=this.svg.selectAll(".line").data(this.linedata);n.transition().style("stroke",function(e){return t.color(e.name)}).style("stroke-dasharray",function(t){return t.dashed?"5, 5":"none"}).attr("d",function(e){return t.line(e.values)}),n.enter().append("g").attr("class",function(t,e){return"line_group line_group"+e}).append("path").attr("class","line").attr("d",function(e){return t.line(e.values)}).style("stroke",function(e){return t.color(e.name)}).style("stroke-width",t.options.strokeWidth).style("stroke-dasharray",function(t){return t.dashed?"5, 5":"none"}).style("stroke-opacity",t.options.opacity);n.exit().selectAll(".dot");n.exit().remove(),i.exit().remove();for(var o=0;o<this.linedata.length;o++){var a=this.linedata[o].values,s=this.svg.select(".line_group"+o).selectAll(".dot").data(a);s.transition().duration(500).delay(e).attr("data",function(t){return t.value}).style("fill",function(){return t.color(t.linedata[o].name)}).attr("cx",function(e){return t.x(e.date)+t.x.rangeBand()/2}).attr("cy",function(e){return t.y(e.value)}),s.enter().append("circle").attr("class","dot").attr("r",this.options.dotRadius).style("fill",function(){return t.color(t.linedata[o].name)}).style("fill-opacity",t.options.opacity).attr("data",function(t){return t.value}).on("mouseover",function(e,i){t.mouseOver(e,i,this)}).on("mouseout",function(e,i){t.mouseOut(e,i,this)}).attr("cx",function(e){return t.x(e.date)+t.x.rangeBand()/2}).attr("cy",function(e){return t.y(e.value)}),s.exit().remove()}},mouseOver:function(t,e,i){var n=this,o=t.value,a=t.date,s="";if(n.options.xFormat&&(a=n.options.xFormat(a)),null!==o){o=n.options.formatter(o);var r={y:o,x:a};s=Mustache.render(n.options.hoverTemplate,r)}else s="NA";d3.select(i).transition().attr("r",this.options.dotRadius+3),d3.select(i).style("fill-opacity",.9),n.container.select(".hoverbox").html(s),n.container.select(".hoverbox").transition().style("display","block")},mouseOut:function(t,e,i){var n=this;d3.select(i).style("fill-opacity",n.options.opacity),d3.select(i).transition().attr("r",this.options.dotRadius),n.container.select(".hoverbox").transition().style("display","none")}}),GeoDash.PieChart=ezoop.ExtendedClass(GeoDash.Chart,{className:"PieChart",defaults:{label:"label",value:"value",colors:["#f00","#0f0","#00f"],innerRadius:10,opacity:1,drawX:!1,drawY:!1,title:!1,padding:10,legend:!1,hover:!0,arclabels:!1,"class":"chart-html piechart-svg",formatter:d3.format(",.0f"),formatPercent:d3.format(".2f"),hoverTemplate:"{{label}}: {{value}} ({{percent}}%)",labelColor:"#ccc",legendWidth:80,arcstroke:2,margin:{top:10,right:10,bottom:10,left:10}},initialize:function(){},setColors:function(t){this.color=d3.scale.ordinal().range(t)},update:function(t){var e=this,i=Math.min(this.width,this.height);this.options.legend&&(i-=this.options.legendWidth);var n=i/2;this.arc=d3.svg.arc().outerRadius(n).innerRadius(this.options.innerRadius),this.pie=d3.layout.pie().sort(null).value(function(t){return t[e.options.value]}),this.color=d3.scale.ordinal().range(this.options.colors),this.total=0,t.forEach(function(i,n){i[e.options.value]=+i[e.options.value],+i[e.options.value]<0?t.splice(n,1):e.total+=+i[e.options.value]});var o=this.svg.selectAll("path").data(this.pie(t));if(o.style("fill",function(t){return e.color(t.data[e.options.label])}).attr("d",this.arc),o.enter().append("path").attr("class","arc").attr("d",this.arc).style("fill",function(t){return e.color(t.data[e.options.label])}).style("fill-opacity",this.options.opacity).style("stroke-width",this.options.arcstroke).on("mouseover",function(t,i){GeoDash.Browser.touch||e.mouseOver(t,i,this)}).on("mouseout",function(t,i){GeoDash.Browser.touch||e.mouseOut(t,i,this)}).on("click",function(t,i){e.activeBar===i?(e.activeBar=-1,e.mouseOut(t,i,this)):(e.activeBar=i,e.mouseOver(t,i,this))}),o.exit().remove(),this.options.arclabels){var a=e.svg.selectAll(".arc-text").data(this.pie(t));a.select("text").attr("transform",function(t){return"translate("+e.arc.centroid(t)+")"}).text(function(t){return t.data[e.options.label]+" ("+t.value+")"}),a.enter().append("g").attr("class","arc-text").append("text").attr("transform",function(t){return"translate("+e.arc.centroid(t)+")"}).attr("dy",".35em").style("text-anchor","middle").style("fill",e.options.labelColor).text(function(t){return t.data[e.options.label]+" ("+t.value+")"}),a.exit().remove()}this.updateLegend()},mouseOver:function(t,e,i){var n=this;if(d3.select(i).style("fill-opacity",1),n.options.hover){var o=t.data[n.options.label],a=n.options.formatter(t.value),s=n.options.formatPercent(t.value/n.total*100),r={label:o,value:a,percent:s};output=Mustache.render(n.options.hoverTemplate,r),n.container.select(".hoverbox").html(output),n.container.select(".hoverbox").style("display","block")}},mouseOut:function(t,e,i){var n=this;n.container.select(".hoverbox").html(""),n.container.select(".hoverbox").style("display","none"),d3.select(i).style("fill-opacity",n.options.opacity)}}),GeoDash.TableChart=ezoop.ExtendedClass(GeoDash.Chart,{className:"TableChart",defaults:{highlight:[],format:!1},initialize:function(){},drawChart:function(){this.margin={top:20,right:10,bottom:20,left:40},this.width=("auto"===this.options.width||void 0===this.options.width?parseInt(d3.select(this.el).style("width")):this.options.width)-this.margin.left-this.margin.right,this.height=("auto"===this.options.height||void 0===this.options.height?parseInt(d3.select(this.el).style("height")):this.options.height)-this.margin.top-this.margin.bottom,this.options.title&&(this.height=this.height-30),this.formatPercent=d3.format(".2%"),this.formatPercentAxisLabel=d3.format(".0%"),this.formatLarge=d3.format("s"),this.formatComma=d3.format(",.2f"),this.table=d3.select(this.el).append("table").attr("width",this.width+this.margin.left+this.margin.right).attr("class","table table-condensed table-bordered gd-table"),this.tbody=this.table.append("tbody")
},update:function(t){var e=this,i=this.tbody.selectAll("tr").data(t).attr("style",function(t){for(var i=t[e.options.columns[0]],n=0;n<e.options.highlight.length;n++)if(e.options.highlight[n]==i)return"background:"+e.options.color;return""});i.enter().append("tr").attr("style",function(t){for(var i=t[e.options.columns[0]],n=0;n<e.options.highlight.length;n++)if(e.options.highlight[n]==i)return"background:"+e.options.color;return""}),i.exit().remove();var n=i.selectAll("td").data(function(t){return e.options.columns.map(function(e){return{column:e,value:t[e]}})});return n.transition().text(function(t){return e.format(t)}),n.enter().append("td").text(function(t){return e.format(t)}),n.exit().remove(),this},format:function(t){var e="",i=this;if(null===t.value)return e="NA";if(isNaN(parseFloat(t.value)))e=t.value;else{if(i.options.format){var n=d3.format(",."+i.options.format.precision+"f");e=n(t.value)}else e=i.formatComma(t.value);i.options.money&&(e="$"+e),i.options.percent&&(e+="%")}return e}});