...
GeoDash.Class=function(){},GeoDash.Class.extend=function(t){var i=function(){this.initialize&&this.initialize.apply(this,arguments),this._initHooks.length&&this.callInitHooks()},n=i.__super__=this.prototype,e=GeoDash.Util.create(n);e.constructor=i,i.prototype=e;for(var o in this)this.hasOwnProperty(o)&&"prototype"!==o&&(i[o]=this[o]);return t.statics&&(GeoDash.extend(i,t.statics),delete t.statics),t.includes&&(GeoDash.Util.extend.apply(null,[e].concat(t.includes)),delete t.includes),e.options&&(t.options=GeoDash.Util.extend(GeoDash.Util.create(e.options),t.options)),GeoDash.extend(e,t),e._initHooks=[],e.callInitHooks=function(){if(!this._initHooksCalled){n.callInitHooks&&n.callInitHooks.call(this),this._initHooksCalled=!0;for(var t=0,i=e._initHooks.length;i>t;t++)e._initHooks[t].call(this)}},i},GeoDash.Class.include=function(t){GeoDash.extend(this.prototype,t)},GeoDash.Class.mergeOptions=function(t){GeoDash.extend(this.prototype.options,t)},GeoDash.Class.addInitHook=function(t){var i=Array.prototype.slice.call(arguments,1),n="function"==typeof t?t:function(){this[t].apply(this,i)};this.prototype._initHooks=this.prototype._initHooks||[],this.prototype._initHooks.push(n)},GeoDash.Util={extend:function(t){var i,n,e,o,a=Array.prototype.slice.call(arguments,1);for(n=0,e=a.length;e>n;n++){o=a[n];for(i in o)t[i]=o[i]}return t},create:Object.create||function(){function t(){}return function(i){return t.prototype=i,new t}}(),bind:function(t,i){var n=Array.prototype.slice;if(t.bind)return t.bind.apply(t,n.call(arguments,1));var e=n.call(arguments,2);return function(){return t.apply(i,e.length?e.concat(n.call(arguments)):arguments)}},stamp:function(t){return t._leaflet_id=t._leaflet_id||++GeoDash.Util.lastId,t._leaflet_id},lastId:0,throttle:function(t,i,n){var e,o,a,s;return s=function(){e=!1,o&&(a.apply(n,o),o=!1)},a=function(){e?o=arguments:(t.apply(n,arguments),setTimeout(s,i),e=!0)}},wrapNum:function(t,i,n){var e=i[1],o=i[0],a=e-o;return t===e&&n?t:((t-o)%a+a)%a+o},falseFn:function(){return!1},formatNum:function(t,i){var n=Math.pow(10,i||5);return Math.round(t*n)/n},trim:function(t){return t.trim?t.trim():t.replace(/^\s+|\s+$/g,"")},splitWords:function(t){return GeoDash.Util.trim(t).split(/\s+/)},setOptions:function(t,i){t.hasOwnProperty("options")||(t.options=t.options?GeoDash.Util.create(t.options):{});for(var n in i)t.options[n]=i[n];return t.options},getParamString:function(t,i,n){var e=[];for(var o in t)e.push(encodeURIComponent(n?o.toUpperCase():o)+"="+encodeURIComponent(t[o]));return(i&&-1!==i.indexOf("?")?"&":"?")+e.join("&")},template:function(t,i){return t.replace(GeoDash.Util.templateRe,function(t,n){var e=i[n];if(void 0===e)throw new Error("No value provided for variable "+t);return"function"==typeof e&&(e=e(i)),e})},templateRe:/\{ *([\w_]+) *\}/g,isArray:Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)},emptyImageUrl:"data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="},function(){function t(t){return window["webkit"+t]||window["moz"+t]||window["ms"+t]}function i(t){var i=+new Date,e=Math.max(0,16-(i-n));return n=i+e,window.setTimeout(t,e)}var n=0,e=window.requestAnimationFrame||t("RequestAnimationFrame")||i,o=window.cancelAnimationFrame||t("CancelAnimationFrame")||t("CancelRequestAnimationFrame")||function(t){window.clearTimeout(t)};GeoDash.Util.requestAnimFrame=function(t,n,o){return o&&e===i?(t.call(n),void 0):e.call(window,GeoDash.bind(t,n))},GeoDash.Util.cancelAnimFrame=function(t){t&&o.call(window,t)}}(),GeoDash.extend=GeoDash.Util.extend,GeoDash.bind=GeoDash.Util.bind,GeoDash.stamp=GeoDash.Util.stamp,GeoDash.setOptions=GeoDash.Util.setOptions,GeoDash.Chart=GeoDash.Class.extend({options:{gdClass:"chart-html",margin:{top:10,right:10,bottom:10,left:10},x:"x",y:"y",width:"auto",height:"auto",drawX:!0,drawY:!0,xLabel:!1,yLabel:!1,opacity:1,hover:!0,legend:!1,legendWidth:80,legendPosition:"middle",axisLabelPadding:20,yAxisWidth:25,yTicksCount:10,xTicksCount:10,hoverTemplate:"{{x}}: {{y}}",xTickFormat:!1,yTickFormat:d3.format(".2s"),valueFormat:d3.format(","),labelFormat:d3.time.format("%Y-%m-%d"),transitionDuration:500},initialize:function(t,i){this.el=t,i=GeoDash.setOptions(this,i),this.drawChart()},drawChart:function(){var t=this;this.setWidth(),this.setHeight(),this.setXAxis(),this.setYAxis(),this.formatPercent=d3.format(".0%"),this.formatLarge=d3.format(".1s"),this.formatComma=d3.format(","),this.formatPercentAxisLabel=d3.format("p"),this.formatMoney=d3.format("$"),d3.select(this.el).html(null),this.container=d3.select(this.el).append("div").attr("class",function(){var i="geodash "+t.options.gdClass;return GeoDash.Browser.ielt9&&(i+=" geodash-oldie"),i}).style("width",this.width+"px").style("height",this.height+"px").style("margin",function(){var i=t.options.margin.top+"px "+t.options.margin.right+"px "+t.options.margin.bottom+"px "+t.options.margin.left+"px";return i}),this.options.title&&this.container.append("div").attr("class","geodash-title").html(this.options.title),this.xAxisElement=this.container.append("div").attr("class","x axis").style("margin",function(){return"0 0 0 "+t.marginleft+"px"}).style("width",function(){return t.xrange+"px"}),t.options.xLabel&&this.xAxisElement.append("div").attr("class","xAxisLabel").style("height",this.options.axisLabelPadding+"px").append("div").attr("class","gd-label").style("line-height",this.options.axisLabelPadding+"px").text(this.options.xLabel),this.yAxisElement=this.container.append("div").attr("class","y axis").style("width",function(){return t.xrange+t.marginleft+"px"}),t.options.yLabel&&this.yAxisElement.append("div").attr("class","yAxisLabel").style("height",this.options.axisLabelPadding+"px").style("width",this.height+"px").append("div").attr("class","gd-label").style("line-height",this.options.axisLabelPadding+"px").text(this.options.yLabel),this.container.append("div").attr("class","bars").style("height",function(){return t.yrange+"px"}).style("width",function(){return t.xrange+"px"}).style("margin",function(){return"0 0 0 "+t.marginleft+"px"}),this.options.legend&&this.container.append("div").attr("class","legend").style("width",this.options.legendWidth+"px").style("background",function(){var i=d3.select(t.el).style("background-color");return i}),this.makeSVG(),this.container.append("div").attr("class","hoverbox")},makeSVG:function(){},updateChart:function(){},setXAxis:function(){var t=this.width,i=0;this.options.legend&&(t-=this.options.legendWidth),this.options.drawY&&(t-=this.options.yAxisWidth,i+=this.options.yAxisWidth),this.options.yLabel&&(t-=this.options.axisLabelPadding,i+=this.options.axisLabelPadding),this.xrange=t,this.marginleft=i,this.x=d3.scale.ordinal().rangeRoundBands([0,t],.05,this.options.outerPadding)},setYAxis:function(){var t=this.height,i=0;this.options.xLabel&&(t-=this.options.axisLabelPadding),this.options.drawX&&(t-=this.options.axisLabelPadding),this.options.barLabels&&(i=15),this.yrange=t,this.y=d3.scale.linear().range([t,i])},updateYAxis:function(){var t=this;if(this.options.drawY){var i=this.y.ticks(t.options.yTicksCount),n=this.yAxisElement.selectAll(".tick").data(i),i=n.transition().duration(this.options.transitionDuration).style("top",function(i){return t.y(i)+"px"}),e=[];i.select(".gd-label").text(function(i){var n;return n=t.options.yTickFormat?t.options.yTickFormat(i):i,t.options.money&&(n="$"+n),t.options.percent&&(n+="%"),e[e.length-1]!==n||0==e.length?(e.push(n),n):""});var o=n.enter().append("div").attr("class","tick").style("top",function(i){return t.y(i)+"px"}).style("left",function(){return t.options.yLabel?t.options.axisLabelPadding+"px":void 0}).style("width",function(){return t.options.yLabel?t.width-t.options.axisLabelPadding+"px":t.width+"px"});n.exit().remove(),o.append("div").attr("class","line").style("width","100%"),o.append("div").attr("class","gd-label").text(function(i){var n;return n=t.options.yTickFormat?t.options.yTickFormat(i):i,t.options.money&&(n="$"+n),t.options.percent&&(n+="%"),e[e.length-1]!==n||0==e.length?(e.push(n),n):""}).style("margin",function(){var t=d3.select(this).style("height"),i=parseInt(t)/2*-1;return i+"px 0 0 0"}).style("width",t.options.yAxisWidth+"px").style("background-color",function(){var i=t.container.style("background-color");return i?i:"#fff"})}},updateXAxis:function(){var t=this;if(this.options.drawX){var i=this.x.domain(),n=this.xAxisElement.selectAll(".tick").data(i),e=n.transition().duration(this.options.transitionDuration).style("left",function(i){return t.x(i)+"px"}).style("width",t.x.rangeBand()+"px");e.select(".line").style("margin",function(){var i=t.x.rangeBand()/2;return"0 0 0 "+i+"px"}),e.select(".gd-label").text(function(i){return t.options.xTickFormat?t.options.xTickFormat(i):i});var o=n.enter().append("div").attr("class","tick").style("left",function(i){return t.x(i)+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(){var i=t.height-t.yrange-t.options.axisLabelPadding;return i+"px"}).style("height",t.options.axisLabelPadding+"px");n.exit().remove(),o.append("div").attr("class","line").style("margin",function(){var i=t.x.rangeBand()/2;return"0 0 0 "+i+"px"}),o.append("div").attr("class","gd-label").style("line-height",t.options.axisLabelPadding+"px").text(function(i){return t.options.xTickFormat?t.options.xTickFormat(i):i})}},updateLegend:function(){if(this.options.legend){var t={width:10,height:10,padding:5},i=3,n=this.container.select(".legend"),e=this.color.domain(),o=n.selectAll(".legend-item").data(e);o.select(".value").text(function(t){return t}),o.select(".swatch").style("background",this.color);var a=o.enter().append("div").attr("class","legend-item");if(a.append("div").attr("class","swatch").style("width",t.width+"px").style("height",t.height+"px").style("background",this.color),a.append("div").attr("class","value").style("width",this.options.legendWidth-t.width-2*i+"px").text(function(t){return t}),o.exit().remove(),"middle"==this.options.legendPosition){var s=parseInt(n.style("height")),r=this.height/2-s/2;n.style("top",r+"px")}else"top"==this.options.legendPosition?n.style("top","0px"):"bottom"==this.options.legendPosition&&n.style("bottom","0px")}},update:function(){},refresh:function(){this.updateChart()},getData:function(){return this.data},setWidth:function(){this.width=parseInt(d3.select(this.el).style("width")),this.width=this.width-this.options.margin.left-this.options.margin.right},setHeight:function(){0!==this.options.barHeight&&"undefined"!=typeof this.options.barHeight&&d3.select(this.el).style("height","auto"),this.height=parseInt(d3.select(this.el).style("height")),this.height=this.height-this.options.margin.top-this.options.margin.bottom,this.options.title&&(this.height=this.height-20)},setYAxisLabel:function(t){this.container.select(".y.axis .yAxisLabel .gd-label").text(t)},setXAxisLabel:function(t){this.container.select(".y.axis .xAxisLabel .gd-label").text(t)},setColor:function(t){this.options.colors=t}}),GeoDash.BarChart=GeoDash.Chart.extend({options:{activeBar:-1,colors:["#f00"],percent:!1,title:!1,money:!1,opacity:.7,roundRadius:3,highlight:[],barLabels:!1,outerPadding:.5}}),GeoDash.BarChartHorizontal=GeoDash.BarChart.extend({options:{gdClass:"chart-html horizontal",barHeight:0,padding:2,xTicksCount:10,topPadding:10,rightBarPadding:10,xTickFormat:d3.format(".2s"),yTickFormat:!1,reverse:!1},setXAxis:function(){var t=this.width,i=0;this.options.legend&&(t-=this.options.legendWidth),this.options.drawY&&(t-=this.options.yAxisWidth,i+=this.options.yAxisWidth),this.options.yLabel&&(t-=this.options.axisLabelPadding,i+=this.options.axisLabelPadding),this.xrange=t,this.marginleft=i,this.x=d3.scale.linear().range([0,t-this.options.rightBarPadding]).nice()},setYAxis:function(){var t=this.height;this.options.drawX&&(t-=this.options.axisLabelPadding),this.options.xLabel&&(t-=this.options.axisLabelPadding),this.yrange=t,this.y=d3.scale.ordinal().rangeRoundBands([t,0],.05,this.options.outerPadding)},update:function(t){function i(t,i,n){null!=t[i]&&"string"==typeof t[i]&&(t[i]=+t[i].replace(",",""));var e={x:t[i],y:t[n]};return e}var n=this;if(this.data=t,0!==this.options.barHeight){var e=this.options.barHeight*t.length+this.options.padding*t.length+2*this.options.topPadding;this.options.drawX&&(e+=this.options.axisLabelPadding),this.options.xLabel&&(e+=this.options.axisLabelPadding),this.height=e,this.container.select(".bars").style("height",e+"px"),this.container.select(".axis").style("height",e+"px"),this.setYAxis()}var o=[],a=this.options.y,s=this.options.x,r=[];n.options.reverse&&t.reverse();for(var l=0;l<t.length;l++){var h=t[l],p=0;if("object"==typeof s)this.stackNumber=s.length,r=s,s.forEach(function(t){var n=i(h,t,a);o.push(n),p+=n.x});else{this.stackNumber=1,r=[s];var u=i(h,s,a);o.push(u),p+=u.x}o[l].total=p}this._data=o,this.color=d3.scale.ordinal().range(this.options.colors).domain(r);var d=d3.extent(this._data,function(t){return t.total});d[0]<0?this.x.domain(d):this.x.domain([0,d[1]]),this.y.domain(this._data.map(function(t){return t.y})),this.updateChart(),this.updateXAxis(),this.updateYAxis(),this.updateLegend()},updateChart:function(){var t=this,i=(this.options.y,this.options.x,this.container.select(".bars").selectAll(".bar").data(this._data));i.transition().duration(this.options.transitionDuration).attr("geodash-id",function(t){return t.y}).style("left",function(i,n){for(var e=t.x(Math.min(0,i.x)),o=n%t.stackNumber;o>0;){var a=t._data[n-o].x,s=t.x(a);s=s%1>.65?s>0?parseInt(s)+1:parseInt(s)-1:parseInt(s),e+=s,o--}return e+=1,e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("top",function(i){var n=0;if(0!==t.options.barHeight){var e=t.y.range().indexOf(t.y(i.y));n=t.options.barHeight*e+t.options.padding*e+t.options.topPadding}else n=t.y(i.y);return n+"px"}).style("width",function(i){var n=Math.abs(t.x(i.x)-t.x(0));return n=n%1>.65?n>0?parseInt(n)+1:parseInt(n)-1:parseInt(n),n+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("opacity",function(i){for(var n=0;n<t.options.highlight.length;n++)if(t.options.highlight[n]==i.y)return 1;return t.options.opacity}).style("border-top-right-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-right-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-top-left-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-left-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("background-color",function(i,n){return t.options.colors[n%t.stackNumber]},"important");var n=i.enter().append("div").attr("class","bar").attr("geodash-id",function(t){return t.y}).style("left",function(i,n){for(var e=t.x(Math.min(0,i.x)),o=n%t.stackNumber;o>0;){var a=t._data[n-o].x,s=t.x(a);s=s%1>.65?s>0?parseInt(s)+1:parseInt(s)-1:parseInt(s),e+=s,o--}return e+=1,e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("top",function(i){var n=0;if(0!==t.options.barHeight){var e=t.y.range().indexOf(t.y(i.y));n=t.options.barHeight*e+t.options.padding*e+t.options.topPadding}else n=t.y(i.y);return n+"px"}).style("width",function(i){var n=Math.abs(t.x(i.x)-t.x(0));return n=n%1>.65?n>0?parseInt(n)+1:parseInt(n)-1:parseInt(n),n+"px"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("opacity",function(i){for(var n=0;n<t.options.highlight.length;n++)if(t.options.highlight[n]==i.y)return 1;return t.options.opacity}).style("border-top-right-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-right-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a>=t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-top-left-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("border-bottom-left-radius",function(i,n){var e=(n+1)%t.stackNumber;if(e)return 0;var o=0,a=t.x(Math.min(0,i.x));return a<t.x(0)&&(o=t.options.roundRadius),o+"px"}).style("-webkit-print-color-adjust","exact").style("background-color",function(i,n){return t.options.colors[n%t.stackNumber]},"important");i.exit().remove(),n.on("mouseover",function(i,n){GeoDash.Browser.touch||t.mouseOver(i,n,this)}).on("mouseout",function(i,n){GeoDash.Browser.touch||t.mouseOut(i,n,this)}).on("click",function(i,n){t.setActiveBar(n)})},updateXAxis:function(){var t=this;if(this.options.drawX){var i=(this.container.select(".x.axis").style("height"),this.x.ticks(t.options.xTicksCount)),n=this.xAxisElement.selectAll(".tick").data(i),i=n.transition().duration(this.options.transitionDuration).style("left",function(i){var n=t.x(i);return n+"px"}).style("height",function(){return t.options.xLabel?t.height-t.options.axisLabelPadding+"px":t.height+"px"});i.select(".gd-label").text(function(i){var n;return n=t.options.xTickFormat?t.options.xTickFormat(i):i,t.options.money&&(n="$"+n),t.options.percent&&(n+="%"),n});var e=n.enter().append("div").attr("class","tick").style("left",function(i){var n=t.x(i);return n+"px"}).style("bottom",function(){return t.options.yLabel?t.options.axisLabelPadding+"px":void 0}).style("height",function(){var i=0;return i=t.options.xLabel?t.height-t.options.axisLabelPadding+"px":t.height+"px"});n.exit().remove(),e.append("div").attr("class","line").style("height","100%"),e.append("div").attr("class","gd-label").text(function(i){var n;return n=t.options.xTickFormat?t.options.xTickFormat(i):i,t.options.money&&(n="$"+n),t.options.percent&&(n+="%"),n}).style("bottom","0px").style("background",function(){var i=d3.select(t.el).style("background-color");return i?i:"#fff"}).style("margin",function(){var t=d3.select(this).style("width"),i=parseInt(t)/2*-1;return"0 0 0 "+i+"px"}).style("height",t.options.axisLabelPadding+"px").style("line-height",t.options.axisLabelPadding+"px")}},updateYAxis:function(){var t=this,i="x";if(this.options.drawY){var n=parseInt(d3.select(t.el).select(".bars").style("width"));isNaN(n)||(barWidth=n);{var e=this.y.domain(),o=this.yAxisElement.selectAll(".tick").data(e);o.transition().duration(this.options.transitionDuration).style("top",function(i,n){var e=0;return e=0!==t.options.barHeight?t.options.barHeight*n+t.options.padding*n+t.options.topPadding:t.y(i),e+"px"}).style("right",function(){return"0px"}).style("padding",function(n,e){var o=t._data[e][i],a=t.x(Math.min(0,o)),s=barWidth-a+2;return"0 "+s+"px 0 0"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("line-height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).select(".gd-label").style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).text(function(t){return t}),o.enter().append("div").attr("class","tick").style("top",function(i,n){var e=0;return e=0!==t.options.barHeight?t.options.barHeight*n+t.options.padding*n+t.options.topPadding:t.y(i),e+"px"}).style("right",function(){return"0px"}).style("padding",function(n,e){var o=t._data[e][i],a=t.x(Math.min(0,o)),s=barWidth-a+2;return"0 "+s+"px 0 0"}).style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).style("line-height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).append("div").attr("class","gd-label").style("height",function(){return 0!==t.options.barHeight?t.options.barHeight+"px":t.y.rangeBand()+"px"}).text(function(t){return t})}o.exit().remove()}},setActiveBar:function(t){var i=this._data[t],n=d3.select(this.el).selectAll(".bar")[0][t];this.options.activeBar===t?(this.options.activeBar=-1,this.mouseOut(i,t,n)):(this.options.activeBar=t,this.mouseOver(i,t,n))},mouseOver:function(t,i,n){var e,o,a=this,s="",o=a._data[i].x,e=a._data[i].y;if("object"==typeof a.options.x&&(e+=" "+a.options.x[i%a.stackNumber]),null!==o){o=a.options.valueFormat(o);var r={y:e,x:o};s=Mustache.render(a.options.hoverTemplate,r)}else s="NA";a.container.selectAll(".bar").style("opacity",function(t,i){return i!==a.options.activeBar?a.options.opacity:1}),d3.select(n).style("opacity",1),a.options.hover&&(a.container.select(".hoverbox").html(s),a.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","block"))},mouseOut:function(t,i,n){for(var e=this,o=e.options.opacity,a=0;a<e.options.highlight.length;a++)e.options.highlight[a]==t&&(o=1);if(d3.select(n).style("opacity",o),e.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","none"),e.options.activeBar>=0){var s=e.container.selectAll(".bar")[0][e.options.activeBar];e.mouseOver(t,e.options.activeBar,s)}},setColor:function(t){this.options.colors=t}}),GeoDash.BarChartVertical=GeoDash.BarChart.extend({options:{gdClass:"chart-html vertical"},update:function(t){function i(t,i,n){null!=t[n]&&"string"==typeof t[n]&&(t[n]=+t[n].replace(",",""));var e={x:t[i],y:t[n]};return e}var n=this.options.y,e=this.options.x;this.data=t;for(var o=[],n=this.options.y,e=this.options.x,a=[],s=0;s<t.length;s++){var r=t[s],l=0;if("object"==typeof n)this.stackNumber=n.length,a=n,n.forEach(function(t){var n=i(r,e,t);o.push(n),l+=n.y});else{this.stackNumber=1,a=[n];var h=i(r,e,n);o.push(h),l+=h.y}o[s].total=l}this._data=o,this.color=d3.scale.ordinal().range(this.options.colors).domain(a),this.x.domain(this._data.map(function(t){return t.x}));var p=d3.extent(this._data,function(t){return t.total});p[0]<0?this.y.domain(p):this.y.domain([0,p[1]]),this.updateChart(),this.updateXAxis(),this.updateYAxis(),this.updateLegend()},updateChart:function(){var t=this,i="y",n="x",e=this.container.select(".bars").selectAll(".bar").data(this._data);e.transition().duration(this.options.transitionDuration).attr("geodash-id",function(t){return t[n]}).style("left",function(i){return t.x(i[n])+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(i,n){var e=0;e=i.y>0?t.yrange-t.y(0):t.yrange-t.y(i.y);for(var o=n%t.stackNumber;o>0;){var a=t._data[n-o].y,s=t.yrange-t.y(a);s=s%1>.65?s>0?parseInt(s)+1:parseInt(s)-1:parseInt(s),e+=s,o--}return e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("height",function(n){var e=0;return e=n[i]>0?t.y(0)-t.y(n[i]):t.y(n[i])-t.y(0),e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("opacity",function(i,n){for(var n=0;n<t.options.highlight.length;n++)if(t.options.highlight[n]==i.y)return 1;return t.options.opacity}).style("background-color",function(i,n){return t.options.colors[n%t.stackNumber]}).style("border-top-right-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]>0?t.options.roundRadius+"px":0}).style("border-top-left-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]>0?t.options.roundRadius+"px":0}).style("border-bottom-right-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]<0?t.options.roundRadius+"px":0}).style("border-bottom-left-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]<0?t.options.roundRadius+"px":0}).style("background-color",function(i,n){return t.options.colors[n%t.stackNumber]},"important").select(".bar-label").style("width",t.x.rangeBand()+"px").style("top","-12px").text(function(i){return t.options.barLabels?t.options.valueFormat(i.y):void 0}),e.enter().append("div").attr("class","bar").attr("geodash-id",function(t){return t[n]}).style("left",function(i){return t.x(i[n])+"px"}).style("width",t.x.rangeBand()+"px").style("bottom",function(i,n){var e=0;e=i.y>0?t.yrange-t.y(0):t.yrange-t.y(i.y);for(var o=n%t.stackNumber;o>0;){var a=t._data[n-o].y,s=t.yrange-t.y(a);s=s%1>.65?s>0?parseInt(s)+1:parseInt(s)-1:parseInt(s),e+=s,o--}return e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("height",function(n){var e=0;return e=n[i]>0?t.y(0)-t.y(n[i]):t.y(n[i])-t.y(0),e=e%1>.65?e>0?parseInt(e)+1:parseInt(e)-1:parseInt(e),e+"px"}).style("opacity",function(i,n){return n===t.options.highlight?1:t.options.opacity}).style("background-color",function(i,n){return t.options.colors[n%t.stackNumber]},"important").style("border-top-right-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]>0?t.options.roundRadius+"px":0}).style("border-top-left-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]>0?t.options.roundRadius+"px":0}).style("border-bottom-right-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]<0?t.options.roundRadius+"px":0}).style("border-bottom-left-radius",function(n,e){var o=(e+1)%t.stackNumber;return o?0:n[i]<0?t.options.roundRadius+"px":0}).on("mouseover",function(i,n){GeoDash.Browser.touch||t.mouseOver(i,n,this)}).on("mouseout",function(i,n){GeoDash.Browser.touch||t.mouseOut(i,n,this)}).on("click",function(i,n){t.setActiveBar(n)}).append("div").attr("class","bar-label").style("width",t.x.rangeBand()+"px").style("top","-12px").text(function(i){return t.options.barLabels?t.options.valueFormat(i.y):void 0}),e.exit().remove()},setActiveBar:function(t){var i=this._data[t],n=d3.select(this.el).selectAll(".bar")[0][t];this.options.activeBar===t?(this.options.activeBar=-1,this.mouseOut(i,t,n)):(this.options.activeBar=t,this.mouseOver(i,t,n))},mouseOver:function(t,i,n){var e,o,a=this,s="",o=a._data[i].x,e=a._data[i].y;if("object"==typeof a.options.y&&(o+=" "+a.options.y[i%a.stackNumber]),null!==e){e=a.options.valueFormat(e);var r={y:e,x:o};s=Mustache.render(a.options.hoverTemplate,r)}else s="NA";a.container.selectAll(".bar").style("opacity",function(t,i){return i!==a.options.activeBar?a.options.opacity:1}),a.options.hover&&(d3.select(n).style("opacity",1),a.container.select(".hoverbox").html(s),a.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","block"))},mouseOut:function(t,i,n){var e=this,o=e.options.opacity;if(t[e.options.x]==e.options.highlight&&(o=1),d3.select(n).style("opacity",o),e.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","none"),e.options.activeBar>=0){var a=e.container.selectAll(".bar")[0][e.options.activeBar];e.mouseOver(t,e.options.activeBar,a)}}}),GeoDash.LineChart=GeoDash.Chart.extend({options:{gdClass:"chart-html linechart vertical",colors:["#d80000","#006200"],interpolate:"monotone",dotRadius:3,strokeWidth:2,xInterval:!1,xTimeInterval:!1,dashed:!1,time:!0,xTickFormat:d3.time.format("%Y-%m-%d"),yTickFormat:d3.format(".2s"),outerPadding:0,linePadding:20,showArea:!1},makeSVG:function(){var t=this;this.svg=this.container.select(".bars").append("svg").attr("height",function(){return t.yrange+"px"}).attr("width",function(){return t.xrange+"px"})},update:function(t){{var i=this,n=this.options.y;this.options.x}this.data=t;for(var e=[],o=0;o<t.length;o++)"object"==typeof n?(this.stackNumber=n.length,e=n):(this.stackNumber=1,e=[n]);this.color=d3.scale.ordinal().range(this.options.colors).domain(e),this.linedata=[],this.color.domain().map(function(n){var e=[];t.map(function(t){var o,a=t[i.options.x];o=null===t[n]?null:+t[n],e.push({x:a,y:o})});var o={name:n,values:e};i.linedata.push(o)}),this.options.dashed&&this.options.dashed.forEach(function(t){var n=i.linedata[t.line];if("undefined"!=typeof n){var e=n.values.length-1,o={};o.name=JSON.parse(JSON.stringify(n.name)),o.values=[],o.dashed=!0;var a=t.span,s=a.start+a.howMany;s>e&&(s=e);for(var r=a.start;s>=r;r++)o.values.push({x:n.values[r].x,y:n.values[r].y});if(a.start>0){var l={};l.name=JSON.parse(JSON.stringify(n.name)),l.values=n.values.slice(0,a.start+1),i.linedata.push(l)}n.values=n.values.slice(a.start+a.howMany),i.linedata.push(o)}});for(var o=0;o<this.linedata.length;o++){for(var a=[],s=0;s<this.linedata[o].values.length;s++){var r=this.linedata[o].values[s].y;isNaN(r)||null===r||a.push(this.linedata[o].values[s])}this.linedata[o].values=a}this.xLine=this.options.time?d3.time.scale().range([0,this.xrange]):d3.scale.linear().range([0,this.xrange]),this.xLine.domain(d3.extent(this.data,function(t){return t[i.options.x]}));var l=[];l=this.options.xInterval?this.xLine.ticks(i.options.xInterval):this.xLine.ticks(t.length),i.options.xTimeInterval&&(l=this.xLine.ticks(i.options.xTimeInterval.timePeriod,i.options.xTimeInterval.interval)),this.x.domain(l),this.options.xInterval||this.options.xTimeInterval?this.xLine.range([this.options.linePadding,this.xrange-this.options.linePadding]):this.xLine.range([this.x.rangeBand()/2,this.xrange-this.x.rangeBand()/2]),this.y.domain([d3.min(this.linedata,function(t){return d3.min(t.values,function(t){return t.y})}),d3.max(this.linedata,function(t){return d3.max(t.values,function(t){return t.y})})]);var h=this.y.domain(),p=h[1]-h[0],u=.1*p,d=h[0]-u,c=h[1]+u;this.y.domain([d,c]),this.updateXAxis(),this.updateYAxis(),this.updateChart(),this.updateLegend()},updateChart:function(){var t=this;this.color=d3.scale.ordinal().range(this.options.colors),this.line=d3.svg.line().interpolate(this.options.interpolate).x(function(i){return t.xLine(i.x)}).y(function(i){return t.y(i.y)}),this.area=d3.svg.area().x(function(i){return t.xLine(i.x)}).y0(this.yrange).y1(function(i){return t.y(i.y)}).interpolate(this.options.interpolate);var i=function(t,i){return 10*i},n=this.svg.selectAll(".line_group").data(this.linedata),e=this.svg.selectAll(".chart-line").data(this.linedata);e.transition().duration(this.options.transitionDuration).attr("stroke",function(i){return t.color(i.name)}).attr("d",function(i){return t.line(i.values)}).attr("stroke-dasharray",function(t){return t.dashed?"4 3":void 0}),e.enter().append("g").attr("class",function(t,i){return"line_group line_group"+i}).append("path").attr("class","chart-line").attr("d",function(i){return t.line(i.values)}).attr("fill","none").attr("stroke",function(i){return t.color(i.name)}).attr("stroke-width",t.options.strokeWidth).attr("stroke-dasharray",function(t){return t.dashed?"4 3":void 0}).attr("stroke-opacity",t.options.opacity),e.exit().remove(),n.exit().remove();for(var o=0;o<this.linedata.length;o++){var a=this.linedata[o].name,s=this.linedata[o].values,r=this.svg.select(".line_group"+o).selectAll(".dot").data(s);r.transition().duration(this.options.transitionDuration).delay(i).attr("data",function(t){return t.y}).attr("fill",function(){return t.color(t.linedata[o].name)}).attr("cx",function(i){return t.xLine(i.x)}).attr("cy",function(i){return t.y(i.y)}),r.enter().append("circle").attr("class","dot").attr("r",this.options.dotRadius).attr("fill",function(){return t.color(t.linedata[o].name)}).attr("fill-opacity",t.options.opacity).attr("data",function(t){return t.y}).attr("label",function(){return a}).on("mouseover",function(i,n){t.mouseOver(i,n,this)}).on("mouseout",function(i,n){t.mouseOut(i,n,this)}).attr("cx",function(i){return t.xLine(i.x)}).attr("cy",function(i){return t.y(i.y)}),r.exit().remove()}if(this.options.showArea){var l=this.svg.selectAll(".area").data(this.linedata);l.enter().append("path").attr("class","area").attr("opacity",.1).attr("fill",function(i){return t.color(i.name)}).attr("d",function(i){return t.area(i.values)}),l.transition().duration(this.options.transitionDuration).attr("fill",function(i){return t.color(i.name)}).attr("d",function(i){return t.area(i.values)}),l.exit().remove()}},updateXAxis:function(){var t=this;if(this.options.drawX){(this.options.xInterval||this.options.xTimeInterval)&&this.x.rangeRoundBands([this.options.linePadding,this.xrange-this.options.linePadding],.05,this.options.outerPadding);var i=this.x.domain(),n=this.xAxisElement.selectAll(".tick").data(i),e=n.transition().duration(this.options.transitionDuration).style("left",function(i){return t.xLine(i)+"px"
}).style("bottom",function(){var i=t.height-t.yrange-t.options.axisLabelPadding;return i+"px"});e.select(".gd-label").text(function(i){return t.options.xTickFormat?t.options.xTickFormat(i):i}).style("margin",function(){var t=parseInt(d3.select(this).style("width")),i=t/2*-1;return"0 0 0 "+i+"px"});var o=n.enter().append("div").attr("class","tick").style("left",function(i){return t.xLine(i)+"px"}).style("bottom",function(){var i=t.height-t.yrange-t.options.axisLabelPadding;return i+"px"}).style("height",t.options.axisLabelPadding+"px");n.exit().remove(),o.append("div").attr("class","line"),o.append("div").attr("class","gd-label").text(function(i){return t.options.xTickFormat?t.options.xTickFormat(i):i}).style("margin",function(){var t=parseInt(d3.select(this).style("width")),i=t/2*-1;return"0 0 0 "+i+"px"})}},mouseOver:function(t,i,n){var e=this,o=t.y,a=t.x,s="";if(e.options.labelFormat&&(a=e.options.labelFormat(a)),"object"==typeof e.options.y&&(a=d3.select(n).attr("label")+" "+a),null!==o){o=e.options.valueFormat(o);var r={y:o,x:a};s=Mustache.render(e.options.hoverTemplate,r)}else s="NA";d3.select(n).transition().duration(this.options.transitionDuration).attr("r",this.options.dotRadius+3),d3.select(n).style("fill-opacity",.9),e.options.hover&&(e.container.select(".hoverbox").html(s),e.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","block"))},mouseOut:function(t,i,n){var e=this;d3.select(n).style("fill-opacity",e.options.opacity),d3.select(n).transition().duration(this.options.transitionDuration).attr("r",this.options.dotRadius),e.container.select(".hoverbox").transition().duration(this.options.transitionDuration).style("display","none")}}),GeoDash.PieChart=GeoDash.Chart.extend({options:{gdClass:"chart-html piechart-svg",label:"label",value:"value",colors:["#f00","#0f0","#00f"],innerRadius:10,padding:10,yAxisWidth:0,axisLabelPadding:0,arclabels:!1,valueFormat:d3.format(",.0f"),formatPercent:d3.format(".2f"),hoverTemplate:"{{label}}: {{value}} ({{percent}}%)",labelColor:"#ccc",arcstrokewidth:2,arcstrokecolor:"#fff",abbreviate:!1,total:!1},makeSVG:function(){var t=this;this.svg=this.container.select(".bars").append("svg").attr("height",function(){return t.yrange+"px"}).attr("width",function(){return t.xrange+"px"}).append("g").attr("transform","translate("+t.xrange/2+","+t.yrange/2+")");var i=Math.min(this.xrange,this.yrange),n=i/2-4;this.arc=d3.svg.arc().outerRadius(n).innerRadius(this.options.innerRadius),this.pie=d3.layout.pie().sort(null).value(function(i){return i[t.options.value]}),this.setColor(this.options.colors)},setColor:function(t){this.options.colors=t,this.color=d3.scale.ordinal().range(this.options.colors)},update:function(t){var i=this,n=!1;"undefined"==typeof this.data&&(n=!0);var e=[];this.options.total?this.total=this.options.total:(this.total=0,t.forEach(function(t){t[i.options.value]=+t[i.options.value],+t[i.options.value]>0&&(i.total+=+t[i.options.value],e.push(t))})),this.data=e,this.updateChart(n)},updateChart:function(t){for(var i=this,n=[],e=0;e<this.data.length;e++)n.push(this.data[e][this.options.label]);this.color.domain(n),this.enterAntiClockwise={startAngle:2*Math.PI,endAngle:2*Math.PI};var o=this.svg.selectAll("path").data(this.pie(this.data)),a=o.enter().append("path").attr("fill",function(t){return i.color(t.data[i.options.label])}).attr("fill-opacity",this.options.opacity).attr("stroke-width",this.options.arcstrokewidth).attr("stroke",this.options.arcstrokecolor).on("mouseover",function(t,n){GeoDash.Browser.touch||i.mouseOver(t,n,this)}).on("mouseout",function(t,n){GeoDash.Browser.touch||i.mouseOut(t,n,this)}).on("click",function(t,n){i.activeBar===n?(i.activeBar=-1,i.mouseOut(t,n,this)):(i.activeBar=n,i.mouseOver(t,n,this))});if(t?a.attr("d",this.arc).each(function(t){this._current=t}):(a.attr("d",this.arc(this.enterAntiClockwise)).each(function(t){this._current={data:t.data,value:t.value,startAngle:i.enterAntiClockwise.startAngle,endAngle:i.enterAntiClockwise.endAngle}}),o.exit().transition().duration(this.options.transitionDuration).attrTween("d",function(t){return i.arcTweenOut(this,t)}).remove(),o.transition().duration(this.options.transitionDuration).attr("fill",function(t){return i.color(t.data[i.options.label])}).attrTween("d",function(t){return i.arcTween(this,t)})),this.options.arclabels){var s=function(t){var n=t.value/i.total*100,e="";return n>=10&&(e=t.data[i.options.label],i.options.abbreviate&&e.length>i.options.abbreviate&&(e=e.substring(0,i.options.abbreviate)+"..")),e},r=i.svg.selectAll(".arc-text").data(this.pie(this.data));r.select("text").text(s),r.transition().duration(this.options.transitionDuration).select("text").attr("transform",function(t){return"translate("+i.arc.centroid(t)+")"}),r.enter().append("g").attr("class","arc-text").append("text").attr("transform",function(t){return"translate("+i.arc.centroid(t)+")"}).attr("dy",".35em").style("text-anchor","middle").style("fill",i.options.labelColor).text(s),r.exit().remove()}this.updateLegend()},arcTween:function(t,i){var n=this,e=d3.interpolate(t._current,i);return t._current=e(0),function(t){return n.arc(e(t))}},arcTweenOut:function(t){var i=this,n=d3.interpolate(t._current,{startAngle:2*Math.PI,endAngle:2*Math.PI,value:0});return t._current=n(0),function(t){return i.arc(n(t))}},mouseOver:function(t,i,n){var e=this;if(d3.select(n).style("fill-opacity",1),e.options.hover){var o=t.data[e.options.label],a=e.options.valueFormat(t.value),s=e.options.formatPercent(t.value/e.total*100),r={label:o,value:a,percent:s};output=Mustache.render(e.options.hoverTemplate,r),e.container.select(".hoverbox").html(output),e.container.select(".hoverbox").style("display","block")}},mouseOut:function(t,i,n){var e=this;e.container.select(".hoverbox").html(""),e.container.select(".hoverbox").style("display","none"),d3.select(n).style("fill-opacity",e.options.opacity)}}),GeoDash.TableChart=GeoDash.Chart.extend({options:{highlight:[],format:!1,valueFormat:d3.format(",")},initialize:function(){},drawChart:function(){this.margin={top:20,right:10,bottom:20,left:40},this.width=("auto"===this.options.width||void 0===this.options.width?parseInt(d3.select(this.el).style("width")):this.options.width)-this.margin.left-this.margin.right,this.height=("auto"===this.options.height||void 0===this.options.height?parseInt(d3.select(this.el).style("height")):this.options.height)-this.margin.top-this.margin.bottom,this.options.title&&(this.height=this.height-30),this.formatPercent=d3.format(".2%"),this.formatPercentAxisLabel=d3.format(".0%"),this.formatLarge=d3.format("s"),this.formatComma=d3.format(",.2f"),this.table=d3.select(this.el).append("table").attr("width",this.width+this.margin.left+this.margin.right).attr("class","table table-condensed table-bordered gd-table"),this.tbody=this.table.append("tbody")},update:function(t){var i=this,n=this.tbody.selectAll("tr").data(t).attr("style",function(t){for(var n=t[i.options.columns[0]],e=0;e<i.options.highlight.length;e++)if(i.options.highlight[e]==n)return"background:"+i.options.color;return""});n.enter().append("tr").attr("style",function(t){for(var n=t[i.options.columns[0]],e=0;e<i.options.highlight.length;e++)if(i.options.highlight[e]==n)return"background:"+i.options.color;return""}),n.exit().remove();var e=n.selectAll("td").data(function(t){return i.options.columns.map(function(i){return{column:i,value:t[i]}})});return e.transition().text(function(t){return i.format(t)}),e.enter().append("td").text(function(t){return i.format(t)}),e.exit().remove(),this},format:function(t){var i="",n=this;return null===t.value?i="NA":(isNaN(parseFloat(t.value))?i=t.value:(n.options.valueFormat&&(i=n.options.valueFormat(t.value)),n.options.money&&(i="$"+i),n.options.percent&&(i+="%")),i)}});