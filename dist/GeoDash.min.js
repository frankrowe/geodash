...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        ...
        p.exit().remove();
        for (var s = 0; s < e.length; s++) {
            var n = e[s].values, u = l.select(".line_group" + s).selectAll(".dot").data(n);
    ...
    update: function(t) {
        ...
        var h = this.container.select(".bars").selectAll(".bar").data(t);
        h.transition().attr("geodash-id", function(t) {
            return t[e];
        ...
        var l = h.enter().append("div").attr("class", "bar").attr("geodash-id", function(t) {
            return t[e];
        }).style("left", function(t) {
            var e = i.x(Math.min(0, t[o]));
            return e === i.x(0) && (e += 1), e + "px";
        ...
        if (h.exit().remove(), l.on("mouseover", function(t, e) {
            i.barmouseover(t, e);
        }).on("mouseout", function(t, e) {
            i.barmouseout(t, e);
        }), this.options.drawX) {
            var d = this.x.ticks(i.options.numberTicks), p = this.xAxisElement.selectAll(".tick").data(d);
            p.transition().style("left", function(t) {
                var e = i.x(t);
    ...
    update: function(t) {
        ...
        if (n.transition().attr("geodash-id", function(t) {
            ...
            var a = this.y.ticks();
            console.log(a);
            var r = this.yAxisElement.selectAll(".tick").data(a), a = r.transition().style("top", function(t) {
                return i.y(t) + "px";
            });
            ...
            var h = r.enter().append("div").attr("class", "tick").style("top", function(t) {
                return i.y(t) + "px";
            }).style("width", "100%");
            r.exit().remove(), h.append("div").attr("class", "line").style("width", "100%"), 
            h.append("div").attr("class", "gd-label").text(function(t) {
                var e = i.formatLarge(t);
                return i.options.money && (e = "$" + e), i.options.percent && (e += "%"), e;
        ...
        if (this.options.drawX) {
            var l = this.x.domain(), r = this.xAxisElement.selectAll(".tick").data(l), a = r.transition().style("left", function(t) {
                return i.x(t) + "px";
            ...
            r.exit().remove(), h.append("div").attr("class", "line").style("margin-left", function() {
                var t = i.x.rangeBand() / 2;
                return t + "px";
            }), h.append("div").attr("class", "gd-label").text(function(t) {
                return t;
