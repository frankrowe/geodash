...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        this.options.title && (this.height = this.height - 30), this.formatPercent = d3.format(".2%"), 
        this.formatPercentAxisLabel = d3.format(".0%"), this.formatLarge = d3.format("s"), 
        this.formatComma = d3.format(","), this.x = d3.scale.linear().range([ 10, this.width - this.options.yWidth ]), 
    ...
    update: function(t) {
        ...
        if (n.transition().attr("geodash-id", function(t) {
            ...
            r.exit().remove(), h.append("div").attr("class", "gd-label").text(function(t) {
                return i.options.percent ? i.formatPercentAxisLabel(t) : i.formatLarge(t);
