...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        this.formatComma = d3.format(","), this.table = d3.select(this.el).append("table").attr("width", this.width + this.margin.left + this.margin.right).attr("class", "table table-condensed table-bordered tablechart-svg"), 
    ...
    update: function(t) {
        ...
        return s.transition().text(function(t) {
            var e = "";
            return parseFloat(t.value) > 0 && parseFloat(t.value) <= 1 && i.options.percent ? e = i.formatPercent(t.value) : isNaN(parseFloat(t.value)) ? e = t.value : (e = i.formatComma(t.value), 
            i.options.money && (e = "$" + e)), e;
    ...
    update: function(t) {
        ...
        if (this.options.drawY) {
            ...
            d.transition().style("margin-top", function() {
                ...
                var r = "";
                i.options.percent ? r = i.formatPercentAxisLabel(n) : (r = i.formatLarge(n), i.options.money && (r = "$" + r)), 
