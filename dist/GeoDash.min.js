...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        this.height = ("auto" === this.options.height || void 0 === this.options.height ? parseInt(d3.select(this.el).style("height")) : this.options.height) - this.margin.top - this.margin.bottom, 
        this.options.title && (this.height = this.height - 30), this.formatPercent = d3.format(".0%"), 
        this.formatLarge = d3.format("s"), this.formatComma = d3.format(","), this.table = d3.select(this.el).append("table").attr("width", this.width + this.margin.left + this.margin.right).attr("class", "table table-condensed table-bordered tablechart-svg"), 
    ...
    drawChart: function() {
        ...
        this.height = ("auto" === this.options.height || void 0 === this.options.height ? parseInt(d3.select(this.el).style("height")) : this.options.height) - this.margin.top - this.margin.bottom, 
        this.options.title && (this.height = this.height - 30), this.formatPercent = d3.format(".0%"), 
        this.formatLarge = d3.format("s"), this.formatComma = d3.format(","), this.x = d3.scale.linear().range([ 10, this.width ]), 
        ...
        this.xAxisElement = this.svg.append("div").attr("class", "x axis"), this.yAxisElement = this.svg.append("div").attr("class", "y axis").style("padding-left", "15px").style("padding-bottom", this.options.padding + "px").style("padding-top", this.options.padding + 15 + "px"), 
        this.svg.append("div").attr("class", "bars").style("padding-bottom", this.options.padding + "px").style("padding-top", this.options.padding + 15 + "px"), 
        d3.select(t.el).append("div").attr("class", "hoverbox");
    },
    update: function(t) {
        var i = this, e = this.options.y, s = this.options.x;
        ...
        if (n.transition().attr("geodash-id", function(t) {
            ...
            var a = this.x.ticks(i.options.numberTicks);
            console.log(a);
            var r = this.xAxisElement.selectAll(".tick").data(a);
            ...
            r.exit().remove(), h.append("div").attr("class", "gd-label").text(function(t) {
                return i.options.percent ? i.formatPercent(t) : i.formatLarge(t);
        ...
        if (this.options.drawY) {
            ...
            d.transition().style("margin-top", function() {
                ...
                return t;
            }).on("mouseover", function(e, o) {
                var n = e, a = t[o][s], r = d3.select(i.el).selectAll(".bar")[0][o];
                d3.select(r).style("opacity", 1), d3.select(i.el).select(".hoverbox").html(n + ": " + (i.options.percent ? i.formatPercent(a) : i.formatComma(a))), 
                d3.select(i.el).select(".hoverbox").transition().style("display", "block");
            }).on("mouseout", function(t, e) {
                var s = i.options.opacity;
                t == i.options.highlight && (s = 1);
                var o = d3.select(i.el).selectAll(".bar")[0][e];
                d3.select(o).style("opacity", s), d3.select(i.el).select(".hoverbox").transition().style("display", "none");
            }), d.exit().remove();
        }
    },
    setColor: function(t) {
