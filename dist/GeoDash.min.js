    ...
    update: function(t) {
        ...
        if (e.append("path").attr("d", this.arc).style("fill", function(t) {
            ...
            var s = {
                ...
                height: 10,
                padding: 5
            }, o = d3.select(this.options.legend).append("svg"), n = o.selectAll(".legend-item").data(this.color.domain().slice().reverse()).enter().append("g").attr("class", "legend-item").attr("transform", function(t, i) {
