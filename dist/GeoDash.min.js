...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    hoverOnDot: function(t, i, e) {
        ...
        var r = d3.select(s.el).select(".line")[0][0].getBBox().width;
    ...
    update: function(t) {
        ...
        var h = r.enter().append("div").attr("class", "bar").attr("geodash-id", function(t) {
            return t[e];
        }).style("left", function(t) {
            var e = i.x(Math.min(0, t[s]));
            return e === i.x(0) && (e += 1), e + "px";
        ...
        if (r.exit().remove(), this.options.drawY || h.on("mouseover", function(t, e) {
            i.barmouseover(t, e);
        }).on("mouseout", function(t, e) {
            i.barmouseout(t, e);
        }), this.options.drawX) {
            var l = this.x.ticks(i.options.numberTicks), d = this.xAxisElement.selectAll(".tick").data(l);
        ...
        if (this.options.drawY) {
            ...
            f.transition().style("margin-top", function() {
                ...
                var o = i.data[e][s], n = i.x(Math.min(0, o)), a = barWidth - n + 2;
                return a + "px";
                ...
                var o = i.data[e][s], n = (Math.abs(i.x(o) - i.x(0)), i.x(Math.min(0, o))), a = barWidth - n + 2;
                return a + "px";
            }).on("mouseover", function(t, e) {
                i.barmouseover(t, e);
            }).on("mouseout", function(t, e) {
    ...
    barmouseover: function(t, i) {
        var e = this, s = "";
        s = "object" == typeof t ? t[e.options.y] : t;
        var o = e.data[i][e.options.x], n = d3.select(e.el).selectAll(".bar")[0][i];
        ...
        d3.select(e.el).select(".hoverbox").html(s + ": " + a), d3.select(e.el).select(".hoverbox").transition().style("display", "block");
    },
    barmouseout: function(t, i) {
        for (var e = this, s = e.options.opacity, o = 0; o < e.options.highlight.length; o++) e.options.highlight[o] == t && (s = 1);
        var n = d3.select(e.el).selectAll(".bar")[0][i];
        d3.select(n).style("opacity", s), d3.select(e.el).select(".hoverbox").transition().style("display", "none");
    },
    setColor: function(t) {
    ...
    update: function(t) {
        ...
        o[0] < 0 ? this.y.domain(o) : this.y.domain([ 0, o[1] ]), console.log(this.y.domain());
        ...
        if (n.transition().attr("geodash-id", function(t) {
            ...
            var s = 0;
            return s = t[e] > 0 ? i.height - i.margin.bottom - i.y(0) : i.height - i.margin.bottom - i.y(t[e]), 
            s + "px";
        }).style("height", function(t) {
            var s = 0;
            return s = t[e] > 0 ? i.y(0) - i.y(t[e]) : i.y(t[e]) - i.y(0), s + "px";
        }).style("opacity", function(t) {
            return t[s] == i.options.highlight ? 1 : i.options.opacity;
        }).style("background-color", function(t) {
            return i.color(t[s]);
            ...
            var a = this.y.ticks(), r = this.yAxisElement.selectAll(".tick").data(a);
            r.transition().style("top", function(t) {
                return i.y(t) + "px";
            });
        ...
        if (this.options.drawX) {
            var l = this.x.domain(), r = this.xAxisElement.selectAll(".gd-label").data(l);
