...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        ...
        if (this.options.drawY) {
            ...
            isNaN(u) || (barWidth = u);
            var f = this.y.domain(), g = this.yAxisElement.selectAll(".gd-label").data(f);
            g.transition().style("top", function(t, e) {
                var o = 0;
                ...
                return t;
            }), g.enter().append("div").attr("class", "gd-label").style("top", function(t, e) {
                var o = 0;
                return o = 0 !== i.options.barHeight ? i.options.barHeight * e + i.options.padding * e + i.options.topPadding : i.y(t), 
                o + "px";
            }).style("right", function() {
    ...
    drawChart: function() {
        ...
        this.y = d3.scale.linear().range([ this.height - this.margin.bottom, 0 ]), this.container = d3.select(this.el).append("div").attr("class", "geodash barchart-html vertical").style("width", this.width + "px").style("height", this.height + "px").style("margin-top", this.margin.top + "px").style("margin-left", function() {
