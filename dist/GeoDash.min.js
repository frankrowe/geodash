...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        ...
        this.options.drawY ? (this.y.domain(t.map(function(t) {
            return t[s];
        })), console.log(this.y.domain()), this.yAxisElement.call(this.yAxis), this.yAxisElement.selectAll("text").style("text-anchor", "start").style("fill", "#333").attr("x", "2").attr("y", "2")) : this.yAxisElement.selectAll("g").remove();
    },
    setColor: function(t) {
        this.options.barColors = t;
    }
