...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        ...
        var n = d3.rgb(d3.select(this.el).style("background")).toString(), r = this.svg.select(".bars").selectAll(".hider").data(t);
        ...
        var h = this.svg.select(".bars").selectAll(".line").data(t);
        h.transition().attr("x1", i.x(0)).attr("x2", i.x(0)).attr("y1", function(t) {
            return i.y(t[e]);
        }).attr("y2", function(t) {
            return i.y(t[e]) + i.y.rangeBand();
        }), h.enter().append("line").attr("class", "line").attr("x1", i.x(0)).attr("x2", i.x(0)).attr("y1", function(t) {
            return i.y(t[e]);
        }).attr("y2", function(t) {
            return i.y(t[e]) + i.y.rangeBand();
        }), h.exit().remove(), this.options.drawX ? this.xAxisElement.call(this.xAxis) : this.xAxisElement.selectAll("g").remove();
    },
    setColor: function(t) {
        this.options.barColors = t;
    }
