...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
...
}, window.GeoDash = GeoDash, GeoDash.Class = function() {}, GeoDash.Class.extend = function(t) {
    var i = t, s = i.extend, e = null, o = this;
    return null == s || "undefined" == typeof s ? (e = function() {
        "undefined" != typeof this.initialize && this.initialize.apply(this, arguments);
    }, e.prototype = i) : (e = function() {
        if (null != typeof s.prototype) {
            var t = s.prototype.initialize;
    ...
    }, o.inheritPrototype(e, s), o.augmentPrototype(e.prototype, i)), e;
}, GeoDash.Class.inheritPrototype = function(t, i) {
    var s = function() {};
    s.prototype = i.prototype, t.prototype = new s(), t.prototype.constructor = t, t.parent = i.prototype;
    ...
    hoverOnDot: function(t, i, s) {
        var e = this, o = this.formatComma(t.value), n = 55 + this.x(t.date), a = 45 + this.y(t.value);
        d3.select(s).transition().attr("r", this.options.dotRadius + 3);
        var h = d3.select(".line")[0][0].getBBox().width;
        this.x(t.date) >= h && (n -= 55), d3.select(e.el).select(".hoverbox").style("left", n + "px"), 
        d3.select(e.el).select(".hoverbox").style("top", a + "px"), d3.select(e.el).select(".hoverbox").html(o), 
        d3.select(e.el).select(".hoverbox").transition().style("display", "block");
    },
    hoverOffDot: function(t, i, s) {
        var e = this;
    ...
    update: function(t) {
        ...
        for (var a = 0; a < s.length; a++) {
            var h = s[a].values, r = e.selectAll(".dotset" + a).data(h);
            r.transition().duration(500).delay(o).attr("data", function(t) {
                ...
                return i.y(t.value);
            }), r.enter().append("circle").attr("class", "dot dotset" + a).attr("r", this.options.dotRadius).style("fill", function() {
                return i.color(s[a].name);
