...
ezoop.noConflict = function() {
    ...
    var s = null, e = ezoop.Class;
    return null == t || "undefined" == typeof t ? (s = function() {
        ...
        var s = "function" == typeof this.initialize ? this.initialize : "undefined";
        "function" == typeof s && s.apply(this, arguments);
    }, e.inheritPrototype(s, t), e.augmentPrototype(s.prototype, i)), s;
...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    var i = t, s = i.extend, e = null, o = GeoDash.Class;
    return null == s || "undefined" == typeof s ? (e = function() {
        "undefined" != typeof this.initialize && this.initialize.apply(this, arguments);
    }, e.prototype = i) : (e = function() {
        if ("undefined" != typeof s.prototype) {
    ...
    hoverOnDot: function(t, i, s) {
        ...
        this.x(t.date) >= r && (n -= 55), d3.select(e.el).select(".hoverbox").style("left", n + "px"), 
    ...
    update: function(t) {
        ...
        for (var a = 0; a < s.length; a++) {
            var r = s[a].values, h = e.selectAll(".dotset" + a).data(r);
