...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        ...
        r.transition().attr("id", function(t) {
            return t[e];
        }).attr("x", function(t) {
        ...
        }), r.enter().append("rect").attr("class", "bar").attr("id", function(t) {
            return t[e];
        }).attr("x", function(t) {
            var e = i.x(Math.min(0, t[s]));
            return e >= i.x(0) && (e -= i.options.roundRadius), e;
        ...
        var h = d3.rgb(d3.select(this.el).style("background-color")).toString(), l = this.svg.select(".bars").selectAll(".hider").data(t);
        l.transition().attr("width", 2 * i.options.roundRadius).attr("height", i.y.rangeBand()).attr("x", i.x(0)).attr("y", function(t) {
            return i.y(t[e]);
        }).attr("transform", function(t) {
            var e = i.x(Math.min(0, t[s]));
            return e < i.x(0) ? "translate(0, 0)" : "translate(" + -1 * 2 * i.options.roundRadius + ", 0)";
        }), l.enter().append("rect").attr("class", "hider").attr("width", 2 * i.options.roundRadius).attr("height", i.y.rangeBand()).attr("x", i.x(0)).attr("y", function(t) {
            return i.y(t[e]);
        }).style("fill-opacity", 1).style("fill", h).attr("transform", function(t) {
            var e = i.x(Math.min(0, t[s]));
            return e < i.x(0) ? "translate(0, 0)" : "translate(" + -1 * 2 * i.options.roundRadius + ", 0)";
        }), l.exit().remove(), this.yAxisElement.append("line").attr("class", "line").attr("x1", i.x(0)).attr("x2", i.x(0)).attr("y2", i.height), 
