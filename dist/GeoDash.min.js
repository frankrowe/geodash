...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        this.yAxis = d3.svg.axis().scale(this.y).tickSize(-1 * this.width).tickFormat(d3.format("s")).tickPadding(10).orient("left"), 
    ...
    update: function(t) {
        ...
        this.x.domain(d3.extent(t, function(t) {
            return t[i.options.x];
        })), console.log(this.x.domain()), this.y.domain([ d3.min(e, function(t) {
