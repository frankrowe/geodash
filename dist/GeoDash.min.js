...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    update: function(t) {
        var i = this;
        i.total = 0, console.log(t), t.forEach(function(t) {
    ...
    update: function(t) {
        ...
        if (r.transition().attr("geodash-id", function(t) {
            ...
            var l = this.x.ticks(i.options.numberTicks), h = this.xAxisElement.selectAll(".tick").data(l);
            h.transition().style("left", function(t) {
                return i.x(t) + "px";
            });
            var d = h.enter().append("div").attr("class", "tick").style("left", function(t) {
                return i.x(t) + "px";
            }).style("height", "100%");
            h.exit().remove(), d.append("div").attr("class", "gd-label").text(function(t) {
                var e = "";
        ...
        if (this.options.drawY) {
            ...
            u.transition().style("margin-top", function() {
                ...
                if (null !== n) if (i.options.percent) r = i.formatPercent(n); else {
                    r = i.formatComma(n);
                    var l = parseFloat(r);
                    0 === l % 1 && (r = r.split(".")[0]), i.options.money && (r = "$" + r);
                } else r = "No Data";
