...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        var i = this.width - this.margin.right;
        this.options.drawY && (i -= this.options.yWidth), this.x = d3.scale.linear().range([ 0, i ]).nice(), 
        this.y = d3.scale.ordinal().rangeRoundBands([ this.height, 0 ], .05, .5), this.container = d3.select(this.el).append("div").attr("class", "geodash barchart-html horizontal").style("width", this.width + "px").style("height", this.height + "px").style("margin-top", this.margin.top + "px").style("margin-bottom", this.margin.bottom + "px").style("margin-right", this.margin.right + "px").style("margin-left", this.margin.left + "px"), 
        this.options.drawX && (this.xAxisElement = this.container.append("div").attr("class", "x axis")), 
        this.options.drawY && (this.yAxisElement = this.container.append("div").attr("class", "y axis"));
        var e = this.container.append("div").attr("class", "bars");
        if (this.options.drawY) {
            e.style("margin-left", this.options.yWidth + "px");
            var o = parseInt(d3.select(t.el).select(".bars").style("width")) - this.options.yWidth;
            e.style("width", o + "px");
        }
        d3.select(t.el).append("div").attr("class", "hoverbox");
    },
    update: function(t) {
        ...
        }).style("top", function(t, o) {
            var s = 0;
            return s = 0 !== i.options.barHeight ? i.options.barHeight * o + i.options.padding * o + i.options.topPadding : i.y(t[e]), 
            s + "px";
        ...
        if (l.exit().remove(), h.on("mouseover", function(t, e) {
            ...
            var d = this.x.ticks(i.options.numberTicks), p = this.xAxisElement.selectAll(".tick").data(d), d = p.transition().style("left", function(t) {
                var e = i.x(t);
                return i.options.drawY && (e += i.options.yWidth), e + "px";
            });
            d.select(".gd-label").text(function(t) {
                var e = i.formatLarge(t);
                return i.options.money && (e = "$" + e), i.options.percent && (e += "%"), e;
            });
            var c = p.enter().append("div").attr("class", "tick").style("left", function(t) {
                var e = i.x(t);
                return i.options.drawY && (e += i.options.yWidth), e + "px";
            }).style("height", "100%");
            p.exit().remove(), c.append("div").attr("class", "line").style("height", "100%"), 
            c.append("div").attr("class", "gd-label").text(function(t) {
                var e = i.formatLarge(t);
                return i.options.money && (e = "$" + e), i.options.percent && (e += "%"), e;
        ...
        if (this.options.drawY) {
            var u = parseInt(d3.select(i.el).select(".bars").style("width"));
            isNaN(u) || (barWidth = u);
            var g = this.y.domain(), f = this.yAxisElement.selectAll(".gd-label").data(g);
            f.transition().style("top", function(t, e) {
                var o = 0;
                return o = 0 !== i.options.barHeight ? i.options.barHeight * e + i.options.padding * e + i.options.topPadding : i.y(t), 
                o + "px";
                ...
                return t;
            }), f.enter().append("div").attr("class", "gd-label").style("top", function(t, e) {
                var o = 0;
                return o = 0 !== i.options.barHeight ? i.options.barHeight * e + i.options.padding * e + i.options.topPadding : i.y(t), 
                o + "px";
            }).style("right", function() {
    ...
    drawChart: function() {
        ...
        var i = this.width;
        this.options.yLabel && (i -= this.options.axisLabelPadding), this.x = d3.scale.ordinal().rangeRoundBands([ 0, i ], .05, .5);
        var e = this.height - this.margin.bottom;
        this.options.xLabel && (e -= this.options.axisLabelPadding), this.y = d3.scale.linear().range([ e, 0 ]), 
        this.container = d3.select(this.el).append("div").attr("class", "geodash barchart-html vertical").style("width", this.width + "px").style("height", this.height + "px").style("margin-top", this.margin.top + "px").style("margin-left", function() {
            return t.margin.left + "px";
        }).style("margin-right", this.margin.right + "px"), this.xAxisElement = this.container.append("div").attr("class", "x axis").style("margin-left", function() {
        ...
        this.container.append("div").attr("class", "bars").style("height", this.height - this.margin.bottom + "px").style("width", function() {
            return t.options.yLabel ? t.width - t.options.axisLabelPadding + "px" : t.width + "px";
        }).style("margin-left", function() {
            return t.options.yLabel ? t.options.axisLabelPadding + "px" : void 0;
    ...
    update: function(t) {
        ...
        s[0] < 0 ? this.y.domain(s) : this.y.domain([ 0, s[1] ]);
        var n = this.container.select(".bars").selectAll(".bar").data(t);
        if (n.transition().attr("geodash-id", function(t) {
            return t[o];
        }).style("left", function(t) {
            return i.x(t[o]) + "px";
        }).style("width", i.x.rangeBand() + "px").style("bottom", function(t) {
            var o = 0;
            return o = t[e] > 0 ? i.height - i.margin.bottom - i.y(0) : i.height - i.margin.bottom - i.y(t[e]), 
            o + "px";
        }).style("height", function(t) {
            var o = 0;
            return o = t[e] > 0 ? i.y(0) - i.y(t[e]) : i.y(t[e]) - i.y(0), o + "px";
        }).style("opacity", function(t) {
            return t[o] == i.options.highlight ? 1 : i.options.opacity;
        }).style("background-color", function(t) {
            return i.color(t[o]);
        }).style("border-top-right-radius", function(t) {
            return t[e] > 0 ? i.options.roundRadius + "px" : 0;
        }).style("border-top-left-radius", function(t) {
            return t[e] > 0 ? i.options.roundRadius + "px" : 0;
        }).style("border-bottom-right-radius", function(t) {
            return t[e] < 0 ? i.options.roundRadius + "px" : 0;
            ...
            i.barMouseOver(t, e, this);
        }).on("mouseout", function(t, e) {
            i.barMouseOut(t, e, this);
        }), n.exit().remove(), this.options.drawY) {
            var a = this.y.ticks(), r = this.yAxisElement.selectAll(".tick").data(a), a = r.transition().style("top", function(t) {
                return i.y(t) + "px";
            });
            a.select(".gd-label").text(function(t) {
                var e = i.formatLarge(t);
                return i.options.money && (e = "$" + e), i.options.percent && (e += "%"), e;
            });
            var l = r.enter().append("div").attr("class", "tick").style("top", function(t) {
                return i.y(t) + "px";
            }).style("margin-left", function() {
                return i.options.yLabel ? i.options.axisLabelPadding + "px" : void 0;
            }).style("width", "100%");
            r.exit().remove(), l.append("div").attr("class", "line").style("width", "100%"), 
            l.append("div").attr("class", "gd-label").text(function(t) {
                var e = i.formatLarge(t);
                return i.options.money && (e = "$" + e), i.options.percent && (e += "%"), e;
        ...
        if (this.options.drawX) {
            var h = this.x.domain(), r = this.xAxisElement.selectAll(".tick").data(h), a = r.transition().style("left", function(t) {
                return i.x(t) + "px";
            }).style("width", i.x.rangeBand() + "px");
            a.select(".line").style("margin-left", function() {
                var t = i.x.rangeBand() / 2;
                return t + "px";
            }), a.select(".gd-label").text(function(t) {
                return t;
            });
            var l = r.enter().append("div").attr("class", "tick").style("left", function(t) {
                return i.x(t) + "px";
            }).style("width", i.x.rangeBand() + "px").style("bottom", function() {
                return i.options.xLabel ? i.options.axisLabelPadding + "px" : "0px";
            }).style("height", i.margin.bottom + "px");
            r.exit().remove(), l.append("div").attr("class", "line").style("margin-left", function() {
                var t = i.x.rangeBand() / 2;
                return t + "px";
            }), l.append("div").attr("class", "gd-label").text(function(t) {
                return t;
    ...
    barMouseOver: function(t, i, e) {
        var o = this;
        d3.select(e).style("opacity", 1);
        var s = t[o.options.x] + ": ";
        s += o.options.percent ? o.formatPercent(t[o.options.y]) : o.formatComma(t[o.options.y]), 
        o.container.select(".hoverbox").html(s), o.container.select(".hoverbox").transition().style("display", "block");
    },
    barMouseOut: function(t, i, e) {
        var o = this, s = o.options.opacity;
        t[o.options.x] == o.options.highlight && (s = 1), d3.select(e).style("opacity", s), 
        o.container.select(".hoverbox").transition().style("display", "none");
    },
    setColor: function(t) {
        this.options.barColors = t;
    }
