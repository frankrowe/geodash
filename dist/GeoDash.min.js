...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        var t = this.svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + this.height + ")"), i = d3.rgb(d3.select(this.el).style("background-color")).toString();
        t.append("rect").attr("width", this.width).attr("height", this.height).attr("transform", "translate(0,1)").style("fill", i);
    },
    update: function(t) {
        ...
        }), o.enter().append("rect").attr("class", "bar").attr("x", function(t) {
            return i.x(t[s]);
        }).attr("width", i.x.rangeBand()).attr("y", function(t) {
            return i.y(t[e]);
