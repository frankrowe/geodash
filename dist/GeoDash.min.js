...
GeoDash.LineChart.prototype.drawChart = function() {
    ...
    d3.select(o).transition().attr("r", this.dotRadius + 3);
    ...
    $(".hoverbox").fadeOut(200), d3.select(o).transition().attr("r", this.dotRadius);
    ...
    for (var h = 0; h < o.length; h++) {
        ...
        n.transition().duration(500).delay(s).attr("data", function(t) {
            ...
            return i.y(t.value);
        }), n.enter().append("circle").attr("class", "dot dotset" + h).attr("r", this.dotRadius).style("fill", function() {
