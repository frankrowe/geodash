...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    drawChart: function() {
        ...
        this.xAxisElement = this.svg.append("div").attr("class", "x axis"), this.options.drawY && (this.yAxisElement = this.svg.append("div").attr("class", "y axis").style("padding-bottom", this.options.padding + "px").style("padding-top", this.options.padding + 15 + "px")), 
    ...
    update: function(t) {
        ...
        if (this.options.drawX) {
            var h = this.x.domain(), a = this.xAxisElement.selectAll(".gd-label").data(h);
